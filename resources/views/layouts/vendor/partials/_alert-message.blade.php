<div class="alert--container active">
    ...
    <div class="alert alert--message-2 alert-dismissible fade show product-limited-stock-alert">
        ...
        <div class="w-0 text-start">
            <h6 class="title text-truncate text-wrap line-2"></h6>
            <span class="message">
            </span>
            <div class="d-flex justify-content-between gap-3 mt-2">
                <a href="javascript:"
                    class="text-decoration-underline text-capitalize product-stock-alert-hide">{{ translate('do_not_show_again') }}</a>
                <a href="javascript:"
                    class="text-decoration-underline text-capitalize product-list">{{ translate('click_to_view') }}</a>
            </div>
        </div>
    ...
    <div class="alert alert--message-2 alert-dismissible fade show product-restock-stock-alert">
        ...
        <div class="w-0 text-start">
            ...
            <div class="d-flex justify-content-between gap-3 mt-2">
                <a href="javascript:"
                    class="text-decoration-underline text-capitalize product-restock-request-alert-hide">{{ translate('do_not_show_again') }}</a>
