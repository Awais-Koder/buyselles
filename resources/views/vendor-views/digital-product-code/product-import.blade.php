        ...
        <div class="mb-3">
            ...
            <nav aria-label="breadcrumb" class="mt-1">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('vendor.products.digital-code-import.product-codes', $product->id) }}">
                            {{ $product->name }}
                        </a>
                    </li>
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-7">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ route('vendor.products.digital-code-import.product-import-upload', $product->id) }}"
