                        ...
                        @else
                            <div class="d-flex align-items-center gap-3 mt-2 mb-2"
                                ...
                                <button type="button" class="btn btn-outline-secondary btn-sm flex-shrink-0"
                                    data-refresh-captcha title="{{ translate('Refresh_captcha') }}">&#8635;</button>
                            ...
                            <script>
                                (function () {
                                    var container = document.querySelector('[data-math-captcha-key="vendorRecaptchaSessionKey"]');
                                    if (!container) return;
                                    function refreshCaptcha() {
                                        fetch('/captcha/math-refresh?session_key=vendorRecaptchaSessionKey', {credentials: 'same-origin'})
                                    ...
                                    window.addEventListener('pageshow', function (e) { if (e.persisted) refreshCaptcha(); });
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <span id="vendor-email"
                                        data-email="{{ \App\Enums\DemoConstant::VENDOR['email'] }}">
                                        {{ translate('email') }}
                                        : {{ \App\Enums\DemoConstant::VENDOR['email'] }}
                                    </span>
                                    <br>
                                    <span id="vendor-password"
                                        data-password="{{ \App\Enums\DemoConstant::VENDOR['password'] }}">
                                        {{ translate('password') }}
                                        : {{ \App\Enums\DemoConstant::VENDOR['password'] }}
                                    </span>
                                </div>
                                <div class="col-2">
