            ...
            <div
                ...
                @if (getActiveAIProviderConfigCache())
                    <button type="button"
                        ...
                        id="price_others_auto_fill" data-route="{{ route('vendor.product.price-others-auto-fill') }}"
                        data-lang="en">
            ...
            <div class="card-body">
                <div class="bg-section rounded-10 p-12 p-sm-20">
                    <div class="row align-items-end">
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                    ...
                                    data-required-msg="{{ translate('unit_price_is_required') }}" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4" id="">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" value="1" step="1"
                                    ...
                                    data-required-msg="{{ translate('minimum_order_qty_is_required') }}" required>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color" for="discount">{{ translate('discount_amount') }} <span
                                            ...
                                            <span
                                                class="input-required-icon">*</span>({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</span>
                                    </label>
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                ...
                                <div class="input-group input-group-merge input-group--merge">
                                    ...
                                    <select class="form-control input-group--merge-action" name="discount_type"
                                        id="discount_type">
                        ...
                        @if ($productWiseTax)
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select multiple-select2 multiple-select-tax-input"
                        ...
                        <div class="col-md-6 col-lg-4 physical_product_show" id="">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value="0" step="1"
                                    ...
                                    id="shipping_cost" class="form-control" required>
                            </div>
                        </div>
                                    ...
                                    <div>
                                        <label class="switcher">
                                            <input type="checkbox" class="switcher_input"
                                                id="is_shipping_cost_multil" name="multiply_qty">
                        ...
                        @include('vendor-views.product.partials._location-section')
                    </div>
                </div>
            </div>
        </div>
