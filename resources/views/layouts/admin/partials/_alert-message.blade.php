<div class="alert--container active">
    ...
    <a href="javascript:" id="order-status-notification-link">
        <div class="alert alert--message-2 alert-dismissible fade show" id="order-status-notification" role="alert">
            ...
            <div class="flex-grow-1">
                <h3>{{ translate('Order_Update') }}</h3>
                <span id="order-status-notification-message">
    ...
    <div
        class="alert alert--message-2 align-items-start alert-dismissible shadow-sm rounded-10 fade show product-limited-stock-alert">
        ...
        <div class="text-start flex-grow-1 w-100">
            <h3 class="title fs-16 fw-semibold text-truncate text-wrap line-1"></h3>
            <span class="message">
            </span>
            <div class="d-flex justify-content-between gap-3 mt-2">
                <a href="javascript:"
                    class="text-decoration-underline text-primary fw-medium text-capitalize product-stock-alert-hide">
                    {{ translate('do_not_show_again') }}
                </a>
                <a href="javascript:"
                    class="text-decoration-underline text-primary fw-medium text-capitalize product-list">
    ...
    <div
        class="alert alert--message-2 align-items-start alert-dismissible ounded-10 shadow-sm fade show product-restock-stock-alert">
        <div class="d-flex min-w-40 aspect-1 overflow-hidden">
        ...
        <div class="flex-grow-1 text-start w-100">
            ...
            <div class="d-flex justify-content-between gap-3 mt-2">
                <a href="javascript:"
                    class="text-decoration-underline text-primary fw-medium product-restock-request-alert-hide">
                    {{ translate('Don’t show again') }}
                </a>
                <a href="javascript:"
                    class="text-decoration-underline text-primary fw-medium get-view-by-onclick product-link"
                    data-link="">
                    {{ translate('Click_to_view') }}
                </a>
            </div>
