@php
    ...
    $_vPerm = VendorPermission::where('seller_id', auth('seller')->id())->first();
    $canAccess = fn(string $module): bool => $_vPerm?->hasAccess($module) ?? true;
@endphp
            ...
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if ($canAccess('vendor_orders') || $canAccess('vendor_refund'))
                            <li class="nav-item">
                                <small class="nav-subtitle">{{ translate('order_management') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                        @endif
                        @if ($canAccess('vendor_orders'))
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/orders/list/pending') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/orders/list/confirmed') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/orders/list/processing') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/orders/list/out_for_delivery') ? 'active' : '' }}">
                                        <a class="nav-link "
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/orders/list/delivered') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/orders/list/returned') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/orders/list/failed') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/orders/list/canceled') ? 'active' : '' }}">
                        ...
                        @if ($canAccess('vendor_products'))
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/products/list/all') || Request::is('vendor/products/update*') || Request::is('vendor/products/view*') ? 'active' : '' }}">
                                        <a class="nav-link "
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/products/list/approved') ? 'active' : '' }}">
                                        <a class="nav-link "
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/products/list/new-request') ? 'active' : '' }}">
                                        <a class="nav-link "
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/products/list/denied') ? 'active' : '' }}">
                                        <a class="nav-link "
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/products/add') || (Request::is('vendor/products/update/*') && request()->has('product-gallery')) ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/products/product-gallery') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/products/stock-limit-list') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/products/bulk-import') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/products/digital-code-import*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('vendor.products.digital-code-import.index') }}"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/products/request-restock-list') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('vendor.products.request-restock-list') }}"
                        ...
                        @endif
                        @if ($canAccess('vendor_coupon') || $canAccess('vendor_clearance_sale'))
                            <li class="nav-item">
                                <small class="nav-subtitle">{{ translate('promotion_management') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                        @endif
                        @if ($canAccess('vendor_coupon'))
                            <li
                        ...
                        @endif
                        @if ($canAccess('vendor_clearance_sale'))
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('vendor/clearance-sale*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('vendor.clearance-sale.index') }}"
                        ...
                        @endif
                        @if ($canAccess('vendor_reports'))
                            <li
                                class="nav-item {{ Request::is('vendor/transaction/order-list') ? 'scroll-here' : '' }}">
                        ...
                        @if ($canAccess('vendor_business_settings') || $canAccess('vendor_wallet') || $canAccess('vendor_shop_settings'))
                        ...
                        @if ($shippingMethod == 'sellerwise_shipping' && $canAccess('vendor_business_settings'))
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    ...
                                    title="{{ translate('shipping_methods') }}">
                        ...
                        @if ($canAccess('vendor_shop_settings'))
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    ...
                                    title="{{ translate('bank_Information') }}">
                        ...
                        @if ($shippingMethod == 'sellerwise_shipping' && $canAccess('vendor_delivery_man'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/delivery-man/index') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('vendor/delivery-man/list') || Request::is('vendor/delivery-man/update') || Request::is('vendor/delivery-man/rating/*') || Request::is('vendor/delivery-man/wallet*') ? 'active' : '' }}">
