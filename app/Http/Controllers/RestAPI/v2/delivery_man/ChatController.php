...
use App\Http\Requests\API\v2\DeliveryMan\DeliveryManSendMessageRequest;
...
class ChatController extends Controller
{
    ...
    public function send_message(DeliveryManSendMessageRequest $request, $type): JsonResponse
    {
