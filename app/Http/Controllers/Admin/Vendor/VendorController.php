...
class VendorController extends BaseController
{
    ...
    public function getOrderDetailsView($order_id, $seller_id, OrderService $orderService): View|RedirectResponse
    {
    ...
    public function getOrderListTabView(Request $request, $seller): View
    {
        ...
        return view('admin-views.vendor.view.order', compact('seller', 'orders', 'pendingOrder', 'deliveredOrder'));
    }
