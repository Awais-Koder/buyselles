...
@push('script')
    ...
    <script>
        // Digital-only checkout: override the proceed button to validate
        // the email field and submit the digital delivery form instead of the
        // normal address-based checkout flow.
