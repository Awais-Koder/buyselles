...
@section('content')
    ...
    <div class="modal fade rtl text-align-direction" id="open-ticket" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg  " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form
                        class="mt-3 form-advance-validation form-advance-inputs-validation form-advance-file-validation non-ajax-form-validate"
                        method="post" action="{{ route('ticket-submit') }}" id="open-ticket" enctype="multipart/form-data"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <div class="">
                                    <label class="font-semibold"
                                        for="inlineFormCustomSelect">{{ translate('type') }}</label>
                            ...
                            <div class="form-group col-md-6">
                                <div class="">
                                    <label class="font-semibold"
                                        for="inlineFormCustomSelect">{{ translate('priority') }}</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label class="font-semibold"
                                    for="ticket-description">{{ translate('describe_your_issue') }}</label>
                        ...
                        <div class="d-flex flex-wrap upload_images_area">
                            ...
                            <label class="py-0 d-flex align-items-center m-0 cursor-pointer">
                                ...
                                <input type="file" id="attachmentfiles"
                                    class="attachmentfiles h-100 position-absolute w-100 "
                                    data-max-size="{{ getFileUploadMaxSize() }}" hidden multiple
    ...
    <div class="container py-4 rtl text-align-direction">
                    ...
                    <div class="card-body">
                        <div class="">
                            <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                ...
                                <button type="submit"
                                    class="btn btn--primary btn-sm font-semibold float-end text-capitalize"
                                    data-toggle="modal" data-target="#open-ticket">
                                    ...
                                    <table class="table mb-0 __table-2 fs-13">
                                        ...
                                        <tbody>
                                            @foreach ($supportTickets as $ticket)
                                                <tr>
                                                    <td>
                                                        <span class="marl fs-13 font-semibold d-block max-w-320">
                                                    ...
                                                    <td><span
                                                            class="fs-13 font-semibold">{{ translate($ticket['type']) }}</span>
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="badge __badge rounded-full {{ $ticket['status'] == 'open' ? 'badge-warning' : 'badge-danger' }}">
                                                    ...
                                                    <td>
                                                        <div class="btn--container flex-nowrap justify-content-center">
                                                            ...
                                                            <button
                                                                class="__action-btn btn-shadow rounded-full text-danger marl delete-ticket-by-modal"
        ...
        <div class="d-flex flex-column gap-3 d-md-none">
            @foreach ($supportTickets as $ticket)
                <div class="bg-white rounded p-3 shadow-sm get-view-by-onclick"
                    data-link="{{ route('support-ticket.index', $ticket['id']) }}">
                    <div class="d-flex justify-content-between gap-2 align-items-end">
                        ...
                        <div>
                            <button
                                class="__action-btn btn-shadow rounded-full text-danger stopPropagation marl delete-ticket-by-modal fs-15"
                                data-link="{{ route('support-ticket.delete', ['id' => $ticket->id]) }}">
                                <i class="czi-trash"></i>
                            </button>
                        </div>
    ...
    <div class="bottom-sticky_ele bg-white d-md-none p-3">
        <button type="submit" class="btn btn--primary w-100 font-semibold" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5">
                    <div class="text-center">
                        <img src="{{ theme_asset(path: 'public/assets/front-end/img/icons/ticket-delete.png') }}"
                            alt="">
    ...
    @if (session('ticket_submitted'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    icon: 'success',
                    title: '{{ translate('Ticket_Submitted') }}',
                    text: '{{ translate('Your_support_ticket_has_been_submitted_successfully_Our_team_will_respond_shortly') }}',
