...
<div class="alert--container active">
    ...
    <a href="javascript:" id="order-status-notification-link">
        <div class="alert alert--message-2 alert-dismissible fade show" id="order-status-notification" role="alert">
            ...
            <div class="w--0">
                <h6 class="mb-1">{{ translate('Order_Update') }}</h6>
    ...
    @if (env('APP_MODE') == 'demo')
        <div class="alert alert--message-2 alert-dismissible fade show" id="demo-reset-warning" role="alert">
            <img width="28" class="align-self-start" src="{{ theme_asset(path: 'assets/img/info-2.png') }}"
                alt="">
            <div class="w--0">
    ...
    <div class="alert alert--message-2 alert-dismissible fade show product-restock-stock-alert">
        ...
        <button type="button"
            class="close position-relative font-semi-bold p-0 product-restock-stock-close btn fw-bold">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
</div>
