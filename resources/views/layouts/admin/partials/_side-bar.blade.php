    ...
    <div class="aside-body search-aside-attribute-container py-4 pt-0">
        ...
        <ul class="aside-nav navbar-nav gap-2">
            ...
            @if (Helpers::module_permission_check('order_management'))
                <li
                    class="nav-item nav-item_title {{ Request::is('admin/orders*') ? (Request::is('admin/orders/details/*') && request()->has('vendor-order-list') ? '' : 'scroll-here') : '' }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/refund-section/refund/list/pending') ? 'active' : '' }}"
                                ...
                                <span class="badge fw-bold badge-danger badge-sm text-bg-danger">
                                    {{ \App\Models\RefundRequest::whereHas('order')->where('status', 'pending')->count() }}
                                </span>
                            </a>
                        </li>
            ...
            @if (Helpers::module_permission_check('product_management'))
                ...
                <li
                    class="{{ Request::is('admin/category*') || Request::is('admin/sub-category*') || Request::is('admin/sub-sub-category*') ? 'sub-menu-opened' : '' }}">
                ...
                <li
                    class="{{ Request::is('admin/products/list/in-house*') || Request::is('admin/products/bulk-import') || Request::is('admin/products/digital-code-import*') || Request::is('admin/products/request-restock-list') || Request::is('admin/products/add') || Request::is('admin/products/view/in-house/*') || Request::is('admin/products/barcode/*') || Request::is('admin/products/stock-limit-list/in_house') || (Request::is('admin/products/update/*') && request()->has('product-gallery')) ? 'sub-menu-opened' : '' }}">
                    <a class="nav-link nav-link-toggle {{ Request::is('admin/products/list/in-house*') || Request::is('admin/products/bulk-import') || Request::is('admin/products/digital-code-import*') || Request::is('admin/products/request-restock-list') || Request::is('admin/products/add') || Request::is('admin/products/view/in-house/*') || Request::is('admin/products/barcode/*') || Request::is('admin/products/stock-limit-list/in_house') || (Request::is('admin/products/update/*') && request()->has('product-gallery')) ? 'active' : '' }}"
                    ...
                    <ul class="aside-submenu navbar-nav">
                        <li class="nav-item px-3 py-2 fw-semibold text-dark bg-section2 aside-mini-show-element">
                            {{ translate('In_House_Products') }}</li>
                        <li class="nav-item ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/products/stock-limit-list/in_house') ? 'active' : '' }}"
                                href="{{ route('admin.products.stock-limit-list', ['in_house']) }}"
                                title="{{ translate('Limited_stock') }}">
                ...
                <li
                    class="{{ Request::is('admin/products/list/vendor*') || Request::is('admin/products/view/vendor/*') || Request::is('admin/products/updated-product-list') ? 'sub-menu-opened' : '' }}">
            ...
            @if (Helpers::module_permission_check('promotion_management'))
                <li
                    class="nav-item nav-item_title {{ Request::is('admin/banner*') || Request::is('admin/coupon*') || Request::is('admin/notification*') || Request::is('admin/deal*') ? 'scroll-here' : '' }}">
                ...
                <li
                    class="{{ Request::is('admin/coupon*') || Request::is('admin/deal*') ? 'sub-menu-opened' : '' }}">
                ...
                <li
                    class="{{ Request::is('admin/notification*') || Request::is('admin/push-notification/index*') ? 'sub-menu-opened' : '' }}">
                ...
                <li class="{{ Request::is('admin/business-settings/announcement*') ? 'sub-menu-opened' : '' }}">
                    <a class="nav-link nav-link-toggle {{ Request::is('admin/business-settings/announcement*') ? 'active' : '' }}"
                        ...
                        <span class="aside-mini-hidden-element text-truncate max-w-180">
                            {{ translate('announcement') }} </span>
                    </a>
                </li>
            @endif
            ...
            @if ($getEnabledThemeRoutes > 0)
                @if (count(config('get_theme_routes')) > 0)
                    ...
                    @foreach (config('get_theme_routes')['route_list'] as $route)
                        @if (isset($route['module_permission']) && Helpers::module_permission_check($route['module_permission']))
                            <li
                                class="{{ Request::is($route['path']) || Request::is($route['path'] . '*') ? 'active' : '' }} @foreach ($route['route_list'] as $sub_route){{ Request::is($sub_route['path']) || Request::is($sub_route['path'] . '*') ? 'active' : '' }} @endforeach">
                                ...
                                @if (count($route['route_list']) > 0)
                                    <ul class="aside-submenu navbar-nav">
                                        <li
                                            class="nav-item px-3 py-2 fw-semibold text-dark bg-section2 aside-mini-show-element">
                                            {{ translate('system_settings') }}</li>
                                        @foreach ($route['route_list'] as $sub_route)
                                            <li
                                                class="{{ Request::is($sub_route['path']) || Request::is($sub_route['path'] . '*') ? 'active' : '' }}">
            ...
            @if (Helpers::module_permission_check('support_section'))
                <li
                    class="nav-item nav-item_title {{ Request::is('admin/support-ticket*') || Request::is('admin/contact*') ? 'scroll-here' : '' }}">
            ...
            @if (Helpers::module_permission_check('report'))
                ...
                Request::is('admin/report/order')
                    ? 'scroll-here'
                    : '' }}

                @if (getCheckAddonPublishedStatus(moduleName: 'TaxModule')) @foreach (include base_path('Modules/TaxModule/Addon/tax_report_routes.php') as $route)
                ...
                <li
                    ...
                    <ul class="aside-submenu navbar-nav">
                        <li class="nav-item px-3 py-2 fw-semibold text-dark bg-section2 aside-mini-show-element">
                            {{ translate('sales_&_Transaction_Report') }}</li>
                        <li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/report/vendor-report') ? 'active' : '' }}"
                                href="{{ route('admin.report.vendor-report') }}"
                ...
                @if (getCheckAddonPublishedStatus(moduleName: 'TaxModule'))
                    @foreach (include base_path('Modules/TaxModule/Addon/tax_report_routes.php') as $route)
                        <li>
                            ...
                            @if (isset($route['sub_routes'])) @foreach ($route['sub_routes'] as $subRoute)
            ...
            @if (Helpers::module_permission_check('user_section'))
                ...
                <li
                    class="{{ Request::is('admin/customer/wallet*') || Request::is('admin/customer/list') || Request::is('admin/customer/view*') || Request::is('admin/reviews*') || Request::is('admin/customer/loyalty/report') ? 'sub-menu-opened' : '' }}">
                ...
                <li
                    class="{{ Request::is('admin/vendors*') || Request::is('admin/vendors/withdraw-method/*') || (Request::is('admin/orders/details/*') && request()->has('vendor-order-list')) ? 'sub-menu-opened' : '' }}">
                    ...
                    <ul class="aside-submenu navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/vendors/withdraw-list') || Request::is('admin/vendors/withdraw-view/*') ? 'active' : '' }}"
                                href="{{ route('admin.vendors.withdraw_list') }}"
                    ...
                    <ul class="aside-submenu navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/delivery-man/list') || Request::is('admin/delivery-man/update*') || Request::is('admin/delivery-man/order-history-log*') || Request::is('admin/delivery-man/order-wise-earning*') ? 'active' : '' }}"
                                href="{{ route('admin.delivery-man.list') }}" title="{{ translate('list') }}">
                                <span class="text-truncate">{{ translate('list') }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                @if (auth('admin')->user()->admin_role_id == 1)
                    <li
                        class=" {{ Request::is('admin/employee*') || Request::is('admin/custom-role*') ? 'sub-menu-opened' : '' }}">
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/customer/subscriber-list') ? 'active' : '' }}"
                        href="{{ route('admin.customer.subscriber-list') }}"
            ...
            @if (Helpers::module_permission_check('business_settings'))
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/business-settings/web-config') ||
                ...
                @if (getCheckAddonPublishedStatus(moduleName: 'TaxModule'))
                    <li>
                        ...
                        @foreach (include base_path('Modules/TaxModule/Addon/tax_routes.php') as $route)
                            ...
                            href="javascript:" title="{{ translate('System_Vat/Tax') }}">
                            <i class="fi fi-rr-calculator-math-tax"></i>
                            <span
                                class="aside-mini-hidden-element flex-grow-1 d-flex justify-content-between align-items-center">
                                <span class="text-truncate max-w-180">
                                    {{ translate('System_Vat/Tax') }}
                                </span>
                                <i class="fi fi-sr-angle-down"></i>
                            </span>
                        </a>
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/seo-settings/web-master-tool') ||
                    ...
                    Request::is('admin/seo-settings/error-logs/index')
                        ? 'active'
                        : '' }}"
                ...
                <li
                    class="{{ Request::is('admin/pages-and-media*') || Request::is('admin/pages-and-media/social-media') ? 'sub-menu-opened' : '' }}">
                    ...
                    <ul class="aside-submenu navbar-nav">
                        <li class="nav-item px-3 py-2 fw-semibold text-dark bg-section2 aside-mini-show-element">
                            {{ translate('pages_&_Media') }}</li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/pages-and-media/list') ||
                            ...
                            Request::is('admin/pages-and-media/company-reliability')
                                ? 'active'
                                : '' }}"
            ...
            @if (Helpers::module_permission_check('system_settings'))
                ...
                Request::is('admin/system-setup/login-settings/otp-setup')
                    ? 'active'
                    : '' }}"
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/system-setup/file-manager*') ? 'active' : '' }}"
                        href="{{ route('admin.system-setup.file-manager.index') }}"
            ...
            @if (Helpers::module_permission_check('3rd_party_setup'))
                ...
                Request::is('admin/third-party/offline-payment-method*')
                    ? 'active'
                    : '' }}"
                ...
                Request::is('admin/third-party/firebase-configuration/authentication')
                    ? 'active'
                    : '' }}"
                ...
                @if (getCheckAddonPublishedStatus(moduleName: 'AI'))
                    <li>
                        <a class="nav-link nav-link-toggle {{ Request::is('admin/third-party/ai-setting') || Request::is('admin/third-party/ai-setting/vendors-usage-limits') ? 'active' : '' }}"
                            href="{{ route('admin.third-party.ai-setting.index') }}"
                            title="{{ translate('AI_Setup') }}">
                            <i class="fi fi-rr-microchip-ai"></i>
                            <span
                                class="aside-mini-hidden-element flex-grow-1 d-flex justify-content-between
                            align-items-center">
                                <span class="text-truncate max-w-180">
                                    {{ translate('AI_Setup') }}
                                </span>
                ...
                <li>
                    ...
                    Request::is('admin/third-party/map-api')
                        ? 'active'
                        : '' }}"
            ...
            @if (Helpers::module_permission_check('themes_and_addons'))
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/system-setup/theme/setup') ? 'active' : '' }}"
                        href="{{ route('admin.system-setup.theme.setup') }}"
                        title="{{ translate('Theme_Setup') }}">
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/system-setup/addon') ? 'active' : '' }}"
                        href="{{ route('admin.system-setup.addon.index') }}"
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/system-setup/addon-activation') ? 'active' : '' }}"
                        href="{{ route('admin.system-setup.addon-activation.index') }}"
                        title="{{ translate('Addon_Activation') }}">
                    ...
                    <li>
                        <a class="nav-link nav-link-toggle @foreach (config('addon_admin_routes') as $routes)
                            @foreach ($routes as $route)
                                {{ strstr(Request::url(), $route['path']) ? 'active' : '' }} @endforeach
                        @endforeach"
                            href="javascript:" title="{{ translate('addon_Menus') }}">
            ...
            <li
                class="nav-item {{ $checkSetupGuideRequirements['completePercent'] < 100 ? 'pt-5 mt-5 d-none d-lg-block' : '' }}">
                <div class="pt-4"></div>
            </li>
        </ul>
    </div>
