...
class DeliveryManController extends Controller
{
    ...
    public function store(DeliveryManAddRequest $request): JsonResponse
    {
        $seller = $request->seller;
        $identity_images = [];
    ...
    public function order_list(Request $request, $id): JsonResponse
    {
        $seller = $request->seller;
    ...
    public function earning(Request $request, $id): JsonResponse
    {
        $seller = $request->seller;
        $delivery_man = DeliveryMan::with('wallet')->where('seller_id', $seller->id)->find($id);
        $total_earn = 0;
