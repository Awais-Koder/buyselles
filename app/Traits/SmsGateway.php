...
trait SmsGateway
{
    ...
    public static function hubtel($receiver, $otp): string
    {
        $config = self::get_settings('hubtel');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
    ...
    public static function paradox($receiver, $otp): string
    {
        $config = self::get_settings('paradox');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
    ...
    public static function sms_019($receiver, $otp): string
    {
        $config = self::get_settings('019_sms');
    ...
    public static function generate_019_api(): bool
    {
        $config = self::get_settings('019_sms');
    ...
    public static function viatech($receiver, $otp): string
    {
        $config = self::get_settings('viatech');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
    ...
    public static function global_sms($receiver, $otp): string
    {
        $config = self::get_settings('global_sms');
        $response = 'error';
    ...
    public static function akandit_sms($receiver, $otp): string
    {
        $config = self::get_settings('akandit_sms');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
    ...
    public static function sms_to($receiver, $otp): string
    {
        $config = self::get_settings('sms_to');
        $response = 'error';
        if (isset($config) && $config['status'] == 1) {
