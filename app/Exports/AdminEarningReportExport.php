...
class AdminEarningReportExport implements FromView, ShouldAutoSize, WithColumnWidths, WithEvents, WithHeadings, WithStyles
{
    use Exportable;
    ...
    {
        return view('file-exports.admin-earning-report', [
            'data' => $this->data,
        ]);
    }
    ...
    public function styles(Worksheet $sheet): array
    {
        ...
        return [
            ...
            'A1:J'.(count($this->data['inhouseEarn']) + 3) => [
                'borders' => [
                    'allBorders' => [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->getStyle('A3:J'.(count($this->data['inhouseEarn']) + 3)) // Adjust the range as per your needs
                    ->getAlignment()
                    ->setHorizontal(Alignment::HORIZONTAL_CENTER)
                    ->setVertical(Alignment::VERTICAL_CENTER);
