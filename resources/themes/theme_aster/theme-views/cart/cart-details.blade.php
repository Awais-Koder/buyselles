                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-center mb-30">
                            <ul class="cart-step-list">
                                ...
                                <li class="cursor-pointer text-capitalize" data-link="{{ route('checkout-details') }}">
                                    <span><i class="bi bi-check2"></i></span> {{ translate('shopping_details') }}
                                </li>
                        ...
                        @foreach ($cart as $group_key => $group)
                            ...
                            <div class="cart_information">
                                @foreach ($group as $cart_key => $cartItem)
                                    ...
                                    @if ($cart_key == 0)
                                        @php
                                            $verify_status = OrderManager::verifyCartListMinimumOrderAmount(
                                                $request,
                                                $group_key,
                                            );
                                        @endphp
                                        ...
                                        <div class="bg-light py-2 px-2 px-sm-3 mb-3 rounded">
                                            <div
                                                class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-lg-nowrap">
                                                ...
                                                @if ($physical_product && $shippingMethod == 'sellerwise_shipping' && $shipping_type == 'order_wise')
                                                    @php
                                                        $choosen_shipping = CartShipping::where([
                                                            'cart_group_id' => $cartItem['cart_group_id'],
                                                        ])->first();
                                                    @endphp

                                                    @php
                                                        $shippings = Helpers::getShippingMethods(
                                                            $cartItem['seller_id'],
                                                            $cartItem['seller_is'],
                                                        );
                                                    @endphp
                                                    @if (count($shippings) > 0 && $choosen_shipping)
                                                        <div
                                                            class="border border-primary-light bg-white rounded px-2 px-sm-3 flex-grow-1 max-w-max-content">
                                                            <div
                                                                class="d-flex gap-2 p-2 flex-wrap text-dark align-items-center">
                                                                <div
                                                                ...
                                                                ?>
                                                                <span class="fw-bold">{{ $shippings_title }}</span>
                                                            </div>
                                                        </div>
                                                    @elseif(count($shippings) == 0)
                                                        <span
                                                            class="badge badge-soft-danger cursor-pointer border-danger border fs-12"
                                ...
                                <div class="table-responsive d-none d-sm-block scrollbar-none">
                                    ...
                                    @endphp
                                    <table
                                        class="table align-middle table-borderless rounded-thead-table fs-13 text-nowrap">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                @if ($shipping_type != 'order_wise')
                                                    <th class="border-0 text-center">{{ translate('shipping_cost') }}
                                                    </th>
                                                @endif
                                            </tr>
                                        </thead>
                                            ...
                                            @foreach ($group as $cart_key => $cartItem)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @else
                                                            <div
                                                                class="quantity quantity--style-two border-primary-light d-inline-flex align-items-center justify-content-center aspect-1 min-h-35px rounded">
                                                                <span
                                                                    class="quantity__minus cartQuantity{{ $cartItem['id'] }} update-cart-quantity-list-cart-data"
                                                                    data-min-order="{{ $product->minimum_order_qty }}"
                                                                    data-prevent=true data-cart="{{ $cartItem['id'] }}"
                                                                    data-value="-1" data-action="delete"
                                    ...
                                    @if ($free_delivery_status['status'] && (session()->missing('coupon_type') || session('coupon_type') != 'free_delivery'))
                                        <div class="free-delivery-area bg-light px-3 py-2 rounded mb-3 max-w-100">
                                            <div class="d-flex align-items-center gap-2 mb-2">
                                                <div
                                                    class="d-flex justify-content-center align-items-center p-2 rounded {{ $free_delivery_status['percentage'] == 100 ? 'bg-success' : 'bg-warning' }} text-absolute-white">

                                                    <img src="{{ theme_asset(path: 'assets/img/icons/free-shipping.svg') }}"
                                                        alt="{{ translate('image') }}" class="" width="20"
                                                        height="20">
                                                </div>
                                ...
                                <div class="d-flex flex-column d-sm-none">
                                    @foreach ($group as $cart_key => $cartItem)
                                        ...
                                        <div
                                            class="border-bottom d-flex align-items-center justify-content-between gap-2 py-2">
                                            <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <div class="media align-items-center gap-2">
                                                    <div
                                                        ...
                                                        <img src="{{ getStorageImages(path: $cartItem?->product?->thumbnail_full_url, type: 'product') }}"
                                                    ...
                                                    <div class="media-body d-flex gap-1 flex-column">
                                                        <h6 class="text-capitalize line-clamp-1 fs-13">
                                                            <a
                                                                href="{{ $checkProductStatus ? route('product', $cartItem['slug']) : 'javascript:' }}">
                                                                {{ $cartItem['name'] }}
                                                            </a>
                                                        </h6>
                                                        @if (!empty($cartItem['variant']))
                                            ...
                                            <div
                                                ...
                                                @else
                                                    <span
                                                        class="quantity__minus update-cart-quantity-list-mobile-cart-data h-100"
                                                        data-prevent=true
                                                        data-min-order="{{ $product->minimum_order_qty }}"
                                                        data-cart="{{ $cartItem['id'] }}" data-value="-1"
                                                        data-action="{{ $cartItem['quantity'] == $product->minimum_order_qty ? 'delete' : 'minus' }}">
                                                    ...
                                                    <input type="hidden"
                                                        ...
                                                        data-cart="{{ $cartItem['id'] }}" data-value="0"
                                                        data-action="" value="{{ $cartItem['quantity'] }}"
                                                        name="quantity" id="cartQuantityMobile{{ $cartItem['id'] }}"
                                                        data-min="{{ $cartItem['quantity'] }}">
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    @if ($free_delivery_status['status'] && (session()->missing('coupon_type') || session('coupon_type') != 'free_delivery'))
                                        <div class="free-delivery-area bg-light px-3 py-2 rounded mb-3 max-w-100">
                                            <div class="d-flex align-items-center gap-2 mb-2">
                                                <div
                                                    class="d-flex justify-content-center align-items-center p-2 rounded bg-warning text-absolute-white">
                                                    <img src="{{ theme_asset(path: 'assets/img/icons/free-shipping.svg') }}"
                        ...
                        @if ($shippingMethod == 'inhouse_shipping')
                            ...
                            @if ($shipping_type == 'order_wise' && $physical_product)
                                ...
                                @if ($choosen_shipping && count($shippings) > 0)
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex align-items-center gap-2 fs-14 text-dark">
                                                <i class="bi bi-truck fs-16"></i>
                                                <span class="fw-bold">{{ translate('Shipping_Method') }}:</span>
                                                <?php
                                                $shippingTitle = '';
                                                foreach ($shippings as $shipping) {
                                                    if ($choosen_shipping['shipping_method_id'] == $shipping['id']) {
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div
                                    ...
                                    <img width="80" class="mb-3"
                                        src="{{ theme_asset('assets/img/empty-state/empty-cart.svg') }}"
                                        alt="">
