        ...
        <div class="container">
            ...
            <div>
                ...
                @if ($headerLocationCountries->count() > 0)
                    <div class="topbar-text dropdown disable-autohide mr-4">
                        <a class="topbar-link dropdown-toggle" href="#" data-toggle="dropdown"
                            id="header-location-toggle">
                            <i class="tio-poi"></i>
                            <span>{{ session('location_label') ?: translate('select_location') }}</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }} p-3"
                            style="min-width: 250px;" id="header-location-dropdown">
                            <div class="mb-2">
                                <select class="form-control form-control-sm" id="header-location-country">
                            ...
                            <div class="mb-2">
                                <select class="form-control form-control-sm" id="header-location-city"
                                    {{ session('location_country_id') ? '' : 'disabled' }}>
                                    <option value="">{{ translate('city') }}</option>
                                </select>
                            </div>
                            <div class="mb-2">
                                <select class="form-control form-control-sm" id="header-location-area"
...
@push('script')
    <script>
        ...
        (function() {
            ...
            const dropdown = document.getElementById('header-location-dropdown');
            if (dropdown) {
