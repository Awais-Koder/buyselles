...
@section('content')
                    ...
                    <div class="p-xxl-4 p-lg-3 p-0">
                        @if (
                            ...
                            <div class="__badge soft-primary py-2 px-xxl-4 px-3 fs-14 text-dark rounded mb-3">
                                ...
                                <strong> {{ $order['bring_change_amount'] }}
                                    {{ $order['bring_change_amount_currency'] ?? '' }}</strong>
                                {{ translate('in change when making the delivery') }}
                            </div>
                        @endif
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center flex-wrap order_info-top">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <h6 class="m-0 fs-12 web-text-primary fw-semibold lh-1">
                                            {{ translate($order['order_type'] == 'POS' ? 'POS' : 'Default') }}</h6>
                                    </div>
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="m-0 fs-12 title-semidark lh-1">{{ translate('payment_status') }}
                                            :</span>
                                        <h6 class="m-0 fs-12 text-success fw-semibold lh-1">{{ $order['payment_status'] }}
                                        </h6>
                                    </div>
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="m-0 fs-12 title-semidark lh-1">{{ translate('Payment method') }}
                                            :</span>
                                        <h6 class="m-0 fs-12 text-dark fw-semibold lh-1">
                                            {{ translate(str_replace('_', ' ', $order['payment_method'])) }}</h6>
                                    </div>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="row g-3 mb-2">
                                <div class="{{ $showVerificationCode ? 'col-md-6' : 'col-md-12' }}">
                                    <div
                                        ...
                                        <div class="">
                                            <h6 class="fs-13 fw-semibold text-capitalize">{{ translate('Order_info') }}
                                            </h6>
                                        </div>
                                        <div class="d-flex flex-column gap-2">
                                            <div class="fs-12 d-flex justify-content-end gap-2">
                                                <span class="text-muted text-capitalize">{{ translate('Order_Type') }}
                                                    :</span>
                                                <span
                                            ...
                                            @if ($order['payment_method'] == 'cash_on_delivery')
                                                <div class="fs-12 d-flex justify-content-end gap-2">
                                                    <span
                                                        class="text-muted text-capitalize">{{ translate('payment_status') }}
                                                        :</span>
                                                    <span
                                                ...
                                                <div class="fs-12 d-flex justify-content-end gap-2">
                                                    <span
                                                        class="text-muted text-capitalize">{{ translate('payment_method') }}
                                                        :</span>
                                                    <span
                                ...
                                @if ($showVerificationCode)
                                    <div class="col-md-6 col-sm-6">
                                        <div
                                            ...
                                            <div class="fs-14 text-dark ">{{ translate('Order verification code') }}</div>
                                    ...
                                    <div class="col-12">
                                        <div class="h-100 light-box rounded-8 p--20">
                                            <div class="d-flex flex-column justify-content-between gap-2">
                                                ...
                                                <div class="row g-3">
                                                    <?php
                                                    $showOnlyPaymentInfo = ($order->edited_status == 1 && ($order?->latestEditHistory?->order_due_payment_method == 'offline_payment' || $order?->latestEditHistory?->order_due_payment_method == 'cash_on_delivery' || $order?->latestEditHistory?->order_due_payment_status == 'paid')) || ($order->edited_status == 1 && $order->edit_due_amount > 0 && $order?->payment_method != 'cash_on_delivery') || ($order->edited_status == 1 && $order?->latestEditHistory?->order_return_payment_status == 'pending') || ($order->edited_status == 1 && $order?->latestEditHistory?->order_return_payment_status == 'returned');
                                                    ?>

                                                    <div class="{{ $showOnlyPaymentInfo ? 'col-md-6' : 'col-md-12' }}">
                                                        <div class="d-flex flex-column gap-2 bg-white rounded py-3 px-3">
                                                            ...
                                                            @if ($order->payment_method == 'offline_payment' && isset($order->offlinePayments))
                                                                <div class="fs-12 d-flex justify-content-start gap-2">
                                                                    <button type="button"
                                                                        ...
                                                                        data-toggle="modal" data-target="#verifyViewModal">
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="text-capitalize text-dark font-weight-bold">{{ translate('Another Payment Info') }}
                                                                        :</span>
                                                                    <span
                                                                ...
                                                                <div class="fs-12 d-flex justify-content-start gap-2">
                                                                    <span
                                                                        class="text-muted text-capitalize">{{ translate('Due amount') }}
                                                                        :</span>
                                                                    <span
                                                                ...
                                                                @if (
                                                                    $order?->latestEditHistory?->order_due_payment_method == 'offline_payment' &&
                                                                        $order?->latestEditHistory?->order_due_payment_info)
                                                                    <div class="fs-12 d-flex justify-content-start gap-2">
                                                                        <button type="button"
                                                                            class="btn bg--secondary mt-1 rounded-pill btn-sm text-capitalize fs-12 font-semi-bold"
                                                                            data-toggle="modal"
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="">
                                                                        <h6
                                                                            class="fs-16 mb-1 text-danger fw-semibold text-capitalize">
                                                                            {{ translate('Pay Due Bill') }}</h6>
                                                                    </div>
                                                                    <p class="fs-12 text-center">
                                                                        ...
                                                                        {{ translate('to continue processing this order') }}
                                                                    </p>
                                                    ...
                                                    @elseif($order->edited_status == 1 && $order?->latestEditHistory?->order_return_payment_status == 'pending')
                                                        <div class="col-md-6 col-sm-6">
                                                            <div
                                                                ...
                                                                <div>
                                                                    <h6
                                                                        class="fs-16 mb-1 text-success fw-semibold text-capitalize">
                                                    ...
                                                    @elseif($order->edited_status == 1 && $order?->latestEditHistory?->order_return_payment_status == 'returned')
                                                        <div class="col-md-6 col-sm-6">
                                                            <div
                                                                ...
                                                                <div class="fs-12 d-flex justify-content-start gap-2">
                                                                    <span
                                                                        class="text-capitalize text-dark">{{ translate('Another Payment Info') }}
                                                                        :</span>
                                                                </div>
                                                                <div class="fs-12 d-flex justify-content-start gap-2">
                                                                    <span
                                                                ...
                                                                <div class="fs-12 d-flex justify-content-start gap-2">
                                                                    <span
                                                                        class="text-muted text-capitalize">{{ translate('Return_Amount') }}
                                                                        :</span>
                                                                    <span
                                                                ...
                                                                <div class="fs-12 d-flex justify-content-start gap-2">
                                                                    <span
                                                                        class="text-muted text-capitalize">{{ translate('Return Payment method') }}
                                                                        :</span>
                                                                    <span
                                ...
                                @if ($order->order_type == 'default_type')
                                    <?php
                                    $shipping = isset($order->shipping_address_data) ? (is_string($order->shipping_address_data) ? json_decode($order->shipping_address_data) : $order->shipping_address_data) : null;
                                    
                                    $billing = isset($order->billing_address_data) ? (is_string($order->billing_address_data) ? json_decode($order->billing_address_data) : $order->billing_address_data) : null;
                                        ...
                                        <div class="{{ $colClass }}">
                                            <div class="light-box rounded-8 p--20 h-100">
                                                ...
                                                <div class="text-capitalize fs-12">
                                                    ...
                                                    : {{ $shipping->phone }}<br>
                                                    <span class="min-w-60px title-semidark">{{ translate('city') }} /
                                                        {{ translate('zip') }}</span>
                                                    :
                                    ...
                                    @if ($hasBilling && !empty((array) $billing))
                                        <div class="{{ $colClass }}">
                                            <div class="light-box rounded-8 p--20 h-100">
                                                ...
                                                <?php
                                                $isSameAddress = $billing && $shipping && !empty((array) $shipping) && $billing->address == $shipping->address && $billing->city == $shipping->city && $billing->zip == $shipping->zip;
                                                ?>
                                                @if ($isSameAddress)
                                                    <div class="bg-white card">
                                                        <div class="d-center py-5 px-4">
                                                            <p class="fs-14 m-0">
                                                                {{ translate('Same as shipping address') }}</p>
                                                        </div>
                                                    </div>
                                                @else
                                                    <div class="text-capitalize fs-12">
                                ...
                                <table class="table table-border min-width-600px">
                                    <thead class="thead-light text-capitalize">
                                        <tr class="fs-13 font-semi-bold">
                                            ...
                                            <th class="fw-semibold fs-14 text-nowrap text-center">{{ translate('qty') }}
                                            </th>
                                            <th class="fw-semibold fs-14 text-nowrap text-right">{{ translate('price') }}
                                            </th>
                                            <th class="fw-semibold fs-14 text-nowrap text-right">
                                                {{ translate('discount') }}</th>
                                            <th class="fw-semibold fs-14 text-nowrap text-right">{{ translate('Total') }}
                                            </th>
                                            <th class="fw-semibold fs-14 text-nowrap text-center">
                                                {{ translate('Action') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                @if ($detail->variant)
                                                                    <small class="fs-12 text-secondary-50">
                                                                        <span
                                                                            class="font-bold">{{ translate('variant') }}
                                                                            : </span>
                                                                        <span
                                                        ...
                                                        @if (
                                                            ($order->order_type == 'default_type' &&
                                                                ($order->order_status == 'delivered' ||
                                                                    (isset($digitalProduct) && ($order->payment_status == 'paid' && $digitalProduct)))) ||
                                                            ...
                                                            <div
                                                                ...
                                                                @if (
                                                                    $product &&
                                                                        ...
                                                                        isset($product['digital_product_type']) &&
                                                                ...
                                                                @elseif(
                                                                    $product &&
                                                                        $order->payment_status == 'paid' &&
                                                                        isset($product['digital_product_type']) &&
                                                                        $product['digital_product_type'] == 'ready_after_sell')
                                    ...
                                    <div class="card-body p-2">
                                        ...
                                        <table class="calculation-table table table-borderless mb-0">
                                            <tbody class="totals">
                                                ...
                                                @if (($orderTotalPriceSummary['customerServiceFee'] ?? 0) > 0)
                                                    <tr>
                                                        <td>
                                                            <div class="text-start">
                                                                <span class="product-qty title-semidark">
                                                        ...
                                                        <td>
                                                            <div class="text-end">
                                                                <span class="fs-15">
                                                                    {{ webCurrencyConverter(amount: $orderTotalPriceSummary['customerServiceFee']) }}
                                                                </span>
                                                            </div>
                                                        </td>
                                                    </tr>
    ...
    @if ($order->order_status == 'delivered')
        ...
        <div class="bottom-sticky_ele bg-white d-md-none p-3 ">
            <button class="btn btn--primary w-100 text_capitalize get-order-again-function"
                data-id="{{ $order->id }}">
                {{ translate('reorder') }}
            </button>
        </div>
