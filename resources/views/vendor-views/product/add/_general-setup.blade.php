<div class="general_wrapper mt-3">
    <div class="outline-wrapper">
        <div class="card rest-part bg-animate">
            <div
                class="card-header d-flex justify-content-between align-items-center border-0 shadow-none pb-0 pc-header-ai-btn">
                <div>
                ...
                @if (getActiveAIProviderConfigCache())
                    <button type="button"
                        ...
                        id="general_setup_auto_fill" data-route="{{ route('vendor.product.general-setup-auto-fill') }}"
                        data-lang="en">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <select class="js-select2-custom form-control action-get-request-onchange"
                                    ...
                                    data-required-msg="{{ translate('category_is_required') }}" required
                                    id="category_id">
                        ...
                        <div class="col-md-6 col-lg-4 digital-product-sections-show">
                            <div class="form-group mb-0">
                                ...
                                <select class="multiple-select2 form-control" name="publishing_house[]"
                                    multiple="multiple">
                        ...
                        <div class="col-md-6 col-lg-4" id="digital_product_type_show">
                            <div class="form-group mb-0">
                                <label for="digital_product_type" class="title-color">{{ translate('delivery_type') }}
                                    <span class="input-required-icon">*</span>
                                </label>
                                ...
                                <select name="digital_product_type" id="digital_product_type" class="form-control"
                                    required>
                                    <option value="" {{ !old('digital_product_type') ? 'selected' : '' }}>
                                        ---{{ translate('select') }}---
                                    </option>
                                    <option value="ready_after_sell"
                                        {{ old('digital_product_type') == 'ready_after_sell' ? 'selected' : '' }}>
                                        {{ translate('ready_After_Sell') }}</option>
                                    <option value="ready_product"
                                        {{ old('digital_product_type') == 'ready_product' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-12" id="digital-product-code-wrapper" style="display:none">
                            <div class="form-group mb-0">
                                <label class="title-color" for="digital_product_code">
                                    {{ translate('Add First Code to Pool') }}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        title="{{ translate('Optionally add one code now. Use the bulk import tool to add multiple codes at once.') }}">
                                        <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                                </label>
                                <input type="text" id="digital_product_code" name="digital_product_code"
                                    class="form-control"
                                    placeholder="{{ translate('e.g. XXXX-XXXX-XXXX-XXXX (optional)') }}"
                                    value="{{ old('digital_product_code') }}" autocomplete="off">
                                <small
                                    class="text-muted">{{ translate('You can add more codes after saving using the bulk import tool.') }}</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" minlength="6" id="generate_number" name="code"
                                    ...
                                    data-required-msg="{{ translate('sku_is_required') }}" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 physical_product_show">
                            <div class="form-group mb-0">
                        ...
                        <div class="col-lg-8">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control"
                                    placeholder="{{ translate('enter_tag') }}" name="tags" id="tags"
                                    data-role="tagsinput">
                            </div>
                        </div>
                    </div>
