        ...
        <div class="widget widget-cart px-3 pt-2 pb-3">
            @if ($cart->count() > 0)
                ...
                <div
                    ...
                    <img src="{{ theme_asset(path: 'public/assets/front-end/img/party-popper.svg') }}" class="mr-2"
                        alt="">
                    ...
                    <div class="py-3">
                        ...
                        <div class="progress __progress bg-DFEDFF">
                            <div class="progress-bar"
                                style="width: {{ $free_delivery_status['percentage'] }}%; background:var(--primary-clr)">
                            </div>
                        </div>
                    </div>
                @endif
