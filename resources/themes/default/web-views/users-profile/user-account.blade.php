                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-inner">
                            <form
                                class="mt-3 px-sm-2 pb-2 form-advance-validation form-advance-inputs-validation form-advance-file-validation non-ajax-form-validate"
                                action="{{ route('user-update') }}" method="post" id="profile_form"
                                ...
                                <div class="row g-3">
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="firstName" class="mb-2 text-capitalize">{{ translate('first_name') }}
                                        </label>
                                        <input type="text" class="form-control" id="f_name" name="f_name"
                                            data-required-msg="{{ translate('first_name_is_required') }}"
                                            value="{{ $customerDetail['f_name'] }}" required>
                                    </div>
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="lastName" class="mb-2 text-capitalize"> {{ translate('last_name') }}
                                        </label>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <input class="form-control phone-input-with-country-picker" id="phone"
                                                type="tel" name="phone" value="{{ $customerDetail['phone'] }}"
                                            ...
                                            @if ($customerDetail['phone'] && getLoginConfig(key: 'phone_verification'))
                                                @if ($customerDetail['is_phone_verified'])
                                                    <span class="position-absolute inset-inline-end-10px cursor-pointer"
                                                        data-toggle="tooltip" data-placement="top"
                                                        title="{{ translate('Your_phone_is_verified') }}">
                                                        <img width="16"
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="inputEmail4" class="mb-2 text-capitalize">{{ translate('email') }}
                                        </label>
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            @if ($customerDetail['email'] && getLoginConfig(key: 'email_verification'))
                                                @if ($customerDetail['is_email_verified'])
                                                    <span class="position-absolute inset-inline-end-10px cursor-pointer"
                                                        data-toggle="tooltip" data-placement="top"
                                                        title="{{ translate('Your_email_is_verified') }}">
                                                        <img width="16"
                                                            src="{{ theme_asset('public/assets/front-end/img/icons/verified.svg') }}"
                                                            class="dark-support" alt="">
                                                    </span>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <div class="password-toggle rtl">
                                            ...
                                            <label class="password-toggle-btn">
                                                ...
                                                <i
                                                    class="tio-hidden password-toggle-indicator password check-password-match"></i>
                                        ...
                                        <div class="password-toggle rtl">
                                            ...
                                            <div>
                                                <label class="password-toggle-btn">
                                                    <input class="custom-control-input" type="checkbox">
                                                    <i
                                                        class="tio-hidden password-toggle-indicator check-password-match"></i>
                                                    <span class="sr-only">{{ translate('show_password') }} </span>
                                                </label>
                                            </div>
                                        </div>
