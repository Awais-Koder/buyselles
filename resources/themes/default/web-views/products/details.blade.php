            ...
            <div class="row g-3 {{ Session::get('direction') === 'rtl' ? '__dir-rtl' : '' }}">
                                    ...
                                    <div class="pd-img-wrap position-relative">
                                            ...
                                            <div class="swiper-wrapper">
                                                @php
                                                    $imageSources =
                                                        ...
                                                        count($product->color_images_full_url) > 0
                                        ...
                                        @if (getProductPriceByType(product: $product, type: 'discount', result: 'value') > 0)
                                            <div class="discount-badge-wrapper">
                                                <span
                                                    class="fs-13 text-white bg-primary text-nowrap fw-bold d-block discount-badge">
                                        ...
                                        <div class="cz-product-gallery-icons">
                                            <div class="d-flex flex-column gap-12px pt-3">
                                                @if ($product->product_type == 'physical')
                                                    <div class="bg-white btn-circle border" style="--size: 35px"
                                                        data-toggle="tooltip" title="{{ translate('Physical_Product') }}"
                                                        data-placement="left">
                                                        <img class="h-16px aspect-1 svg"
                                                            src="{{ theme_asset(path: 'public/assets/front-end/img/icons/physical-product.svg') }}"
                                                            alt="">
                                                    </div>
                                                @else
                                                    <div class="bg-white btn-circle border" style="--size: 35px"
                                                        data-toggle="tooltip" title="{{ translate('Digital_Product') }}"
                                                        data-placement="left">
                                                        <img class="h-16px aspect-1 svg"
                                                            src="{{ theme_asset(path: 'public/assets/front-end/img/icons/digital-product.svg') }}"
                                                            alt="">
                                                    </div>
                                                @endif
                                                <button type="button" data-product-id="{{ $product['id'] }}"
                                                    ...
                                                    <div class="wishlist-tooltip" x-placement="top">
                                                        ...
                                                        <div class="inner">
                                                            <span
                                                                class="add">{{ translate('added_to_wishlist') }}</span>
                                                            <span
                                                                class="remove">{{ translate('removed_from_wishlist') }}</span>
                                                        </div>
                                                    </div>
                                                </button>
                                                ...
                                                <div class="share_dropdown_wrapper">
                                                    <button type="button"
                                                        class="btn btn-outline-primary btn-circle p-0 share_btn"
                                                        style="--size: 35px" tabindex="0">
                                                        <i class="fa fa-share-alt"></i>
                                                    </button>
                                                    <div
                                                        class="share_dropdown bg-white d-flex gap-3 align-items-center flex-column">
                                                        <a href="#"
                                                            class="flex-shrink-0 btn btn-circle p-0 bg-facebook text-white share-on-social-media share_btn facebook"
                                                            style="--size: 20px"
                                                        ...
                                                        <a href="#"
                                                            class="flex-shrink-0 btn btn-circle p-0 bg-twitter text-white share-on-social-media share_btn twitter"
                                                            style="--size: 20px"
                                                            data-action="{{ route('product', $product->slug) }}"
                                                        ...
                                                        <a href="#"
                                                            class="flex-shrink-0 btn btn-circle p-0 bg-linkedin text-white share-on-social-media share_btn linkedin"
                                                            style="--size: 20px"
                                                            data-action="{{ route('product', $product->slug) }}"
                                                        ...
                                                        <a href="#"
                                                            class="flex-shrink-0 btn btn-circle p-0 bg-whatsapp text-white share-on-social-media share_btn whatsapp"
                                                            style="--size: 20px"
                                                            data-action="{{ route('product', $product->slug) }}"
                                    ...
                                    <div class="details __h-100 product-cart-option-container p-0">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center gap-3 mb-4 pro">
                                            @if ($overallRating[0] != 0)
                                                ...
                                                <span
                                                    class="d-inline-block  align-middle fs-14 text-muted">({{ $overallRating[0] }})</span>
                                                <span
                                                    ...
                                                    <a href="#reviews"
                                                        ...
                                                        <span
                                                            class="web-text-primary fw-semibold">{{ $overallRating[1] }}</span>
                                                        {{ translate('reviews') }}
                                                    </a>
                                                </span>
                                            ...
                                            <span
                                                class="font-weight-normal fs-14 font-for-tab d-inline-block font-size-sm text-body align-middle">
                                                <span
                                                    class="web-text-primary fw-semibold fw-semibold">{{ $countOrder }}</span>
                                                {{ translate('orders') }}
                                            </span>
                                            <span class="border-middle-14px"></span>
                                            <span
                                                ...
                                                <span
                                                    class="web-text-primary fw-semibold countWishlist-{{ $product->id }}">
                                                    {{ $countWishlist }}</span> {{ translate('wish_listed') }}
                                            </span>
                                        </div>
                                        ...
                                        <form
                                            ...
                                            <div class="">
                                                <h3
                                                    class="font-weight-normal text-accent d-flex align-items-end gap-2 mb-0">
                                                    @if (getProductPriceByType(product: $product, type: 'discount', result: 'value') > 0)
                                                        <del
                                            ...
                                            <div class="position-relative">
                                                @if (count(json_decode($product->colors)) > 0)
                                                    <div class="d-flex align-items-center gap-3 my-0">
                                                        ...
                                                        <div>
                                                            <ul
                                                                class="list-inline checkbox-color mb-0 p-0 flex-start gap-2">
                                            ...
                                            <div class="__btn-grp product-add-and-buy-section-parent">
                                                ...
                                                <div class="product-add-and-buy-section gap-2 {!! $firstVariationQuantity <= 0 ? '' : 'd-flex' !!}"
                                                    ...
                                                    @if ($isTemporaryClose || $isVacationMode)
                                                        ...
                                                        <button class="btn btn--primary string-limit" type="button"
                                                            disabled>
                                    ...
                                    <div class="tab-pane fade show active text-justify" id="overview" role="tabpanel">
                                        <div class="details-content-wrap ov-hidden show-more--content">
                                            <div class="row pt-2 specification">
                                                ...
                                                @if ($product->video_url != null && str_contains($product->video_url, 'youtube.com/embed/'))
                                                    <div class="col-12 mb-4">
                                                        <iframe width="420" height="315"
                                                            src="{{ $product->video_url }}" title="YouTube video player"
                                                            frameborder="0"
                                                ...
                                                @endif
                                                @if ($product['details'])
                                                    <h4 class="fs-16 fw-bold mb-3 px-1">
                                                        {{ translate('Detail_Description') }}</h4>
                ...
                <div class="col-lg-3">
                    ...
                    @if ($product->product_type == 'physical')
                        ...
                        @endif
                    @else
                        {{-- Digital product: show delivery info and non-returnable notice --}}
                        <div class="product-details-shipping-details">
                            <div class="shipping-details-bottom-border">
                                <div class="px-3 py-3 d-flex align-items-center gap-2">
                                    <i class="tio-flash-outlined fs-20 web-text-primary"></i>
                                    <span class="fw-semibold">{{ translate('Instant_Digital_Delivery') }}</span>
                                </div>
                            </div>
                            <div class="shipping-details-bottom-border">
                                <div class="px-3 py-3 d-flex align-items-center gap-2">
                                    <i class="tio-lock-outlined fs-20 web-text-primary"></i>
                                    <span>{{ translate('Secure_&_Encrypted_Code') }}</span>
                                </div>
                            </div>
                            <div class="shipping-details-bottom-border">
                                <div class="px-3 py-3 d-flex align-items-center gap-2">
                                    <i class="tio-info-outined fs-20 text-warning"></i>
                                    <span
                                        class="text-muted fs-12">{{ translate('Digital_items_are_non-returnable') }}</span>
                                </div>
                            </div>
                        </div>
                    @endif
                                ...
                                <div class="row position-relative d-flex justify-content-between">
                                    <div class="col-9">
                                        <a href="{{ route('vendor-shop', ['slug' => getInHouseShopConfig(key: 'slug')]) }}"
                                            ...
                                            <div>
                                                <div class="{{ session('direction') === 'rtl' ? 'right' : 'ml-2' }} get-view-by-onclick"
                                                ...
                                                <div
                                                    class="fs-12 {{ session('direction') === 'rtl' ? 'right' : 'ml-2' }}">
                                                    {{ translate('Seller_info') }}</div>
                                            </div>
                                        </a>
                                    </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("shown.bs.tab", ".tab_link", function() {
                applyShowMoreLogic();
            });

            $(document).on("click", ".see-more-details", function() {
                let tabPane = $(this).closest(".tab-pane");
                let content = tabPane.find(".details-content-wrap");
                let productDetailsDescription = tabPane.find(".p-details-description");

                content.toggleClass(" active");

                if (content.hasClass("active")) {
                    $(this).html($("#all-msg-container").data("seemore"));
                    productDetailsDescription.removeClass('overflow-y-auto');
                } else {
