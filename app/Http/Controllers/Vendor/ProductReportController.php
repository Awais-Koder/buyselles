...
class ProductReportController extends Controller
{
    ...
    public function all_product(Request $request): View
    {
        ...
        $chartDataTotalProductLabel = array_values(collect(array_keys($chart_data['total_product']))->map(function ($item) use ($request) {
        ...
        return view('vendor-views.report.all-product', compact('products', 'chart_data', 'total_sales_value',
            'total_product_sale', 'total_product_sale_amount', 'top_product', 'total_discount_given', 'product_count', 'search', 'date_type', 'from', 'to', 'chartDataTotalProductLabel'));
    }
