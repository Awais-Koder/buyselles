...
@section('content')
                ...
                <div class="card h-100">
                    <div class="card-body">
                                            ...
                                            <span>
                                                ...
                                                @if (strlen($order['order_note']) > 250)
                                                    <a href="javascript:void(0)" class="text-primary ms-1"
                                                        data-bs-toggle="modal" data-bs-target="#orderNoteModal">
                                                        {{ translate('Read more') }}
                                                    </a>
                                        ...
                                        <div
                                            ...
                                            <span>
                                                ...
                                                <span class="fw-semibold">
                                                    {{ $order['bring_change_amount'] }}
                                                    {{ $order['bring_change_amount_currency'] ?? '' }}
                                                </span>
                            ...
                            <div class="text-sm-end flex-grow-1">
                                <div class="d-flex flex-wrap gap-10 justify-content-start justify-content-lg-end">
                                    ...
                                    @if ($isOrderEditable['status'] === true)
                                        <buton type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal"
                        ...
                        <div class="table-responsive">
                            <table class="table fs-12 table-hover table-borderless align-middle">
                                                ...
                                                <td>
                                                    <div class="{{ $isProductUnavailable ? 'table-row-disabled' : '' }}"
                                                        ...
                                                        <div class="media align-items-center gap-10">
                                                            ...
                                                            <div>
                                                                <a target="_blank" class="text-dark fs-12 fw-bold"
                                                                    href="{{ route('admin.products.view', ['addedBy' => $productDetails['added_by'] == 'seller' ? 'vendor' : 'in-house', 'id' => $productDetails['id']]) }}"
                                                                    @if (!$isProductUnavailable && strlen($productDetails['name']) > 30) data-bs-toggle="tooltip"
                                ...
                                <div class="overflow-x-auto min-w-300 min-w-100-mobile">
                                    <table class="table table-borderless table-sm mb-0 text-sm-right text-nowrap fs-12">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-start text-dark text-capitalize">
                                                    <span>{{ translate('item_discount') }}</span>
                                                </td>
                                                <td class="text-end text-dark">
                                                    -
                                            ...
                                            <tr>
                                                <td class="text-start text-dark text-uppercase">
                                                    <span>{{ translate('vat') }}/{{ translate('tax') }}</span>
                                                </td>
                                                <td class="text-end text-dark">
                                            ...
                                            @if (($orderTotalPriceSummary['customerServiceFee'] ?? 0) > 0)
                                                <tr>
                                                    ...
                                                    <td class="text-end text-dark">
                                                        <span>{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $orderTotalPriceSummary['customerServiceFee']), currencyCode: getCurrencyCode()) }}</span>
                                                    </td>
                                                </tr>
                                            @endif
                                            <tr>
                                            ...
                                            @if ($order->order_type == 'pos' || $order->order_type == 'POS')
                                                <tr>
                                                    <td class="text-start text-dark text-capitalize">
                                                        <span>{{ translate('paid_Amount') }}</span>
                                                    </td>
                                                    <td class="text-end text-dark">
                                                ...
                                                <tr>
                                                    <td class="text-start text-dark text-capitalize">
                                                        <span>{{ translate('change_Amount') }}</span>
                                                    </td>
                                                    <td class="text-end text-dark">
                                            ...
                                            @if ($order['edited_status'] == 1 && $order?->latestEditHistory)
                                                ...
                                                @if ($order?->latestEditHistory?->order_due_amount > 0)
                                                    @if ($order?->latestEditHistory?->order_due_payment_status == 'paid')
                                                        ...
                                                        <tr>
                                                            <td
                                                                class="text-start text-dark text-capitalize d-flex flex-column">
                                    ...
                                    @foreach ($order?->orderEditHistory as $orderEditHistory)
                                        <div>
                                            <div class="fs-12 mb-2">
                                                ...
                                                {{ $orderEditHistory['edited_user_name'] }}
            ...
            <div class="col-xl-4 d-flex flex-column gap-3">
                ...
                <div class="card card-body">
                                    ...
                                    <div class="d-flex gap-3 align-items-center overflow-wrap-anywhere">
                                        ...
                                        <span class="fw-semibold">
                                            @if (strlen($order?->payment_note) > 250)
                                                ...
                                                <a href="javascript:void(0)" class="text-primary ms-1"
                                                    data-bs-toggle="modal" data-bs-target="#paymentNoteModal">
                                                    {{ translate('Read more') }}
                                                </a>
                                            @else
                    ...
                    $filteredEditPaymentHistory = $orderEditPaymentHistory->filter(function ($item) {
                        return $item->order_due_payment_status === 'paid' || $item->order_return_payment_status === 'returned';
                    });
                    ?>
                                    ...
                                    <div class="d-flex gap-3 align-items-center overflow-wrap-anywhere">
                                        ...
                                        <span class="fw-semibold d-flex flex-wrap gap-2">
                                            ...
                                            @if (!empty($order?->latestEditHistory?->order_return_payment_method))
                                                <span
                                                    class="fs-12">({{ translate($order?->latestEditHistory?->order_return_payment_method) }})</span>
                                            @endif
                                            <span
                                    ...
                                    <div class="d-flex gap-3 align-items-center overflow-wrap-anywhere">
                                        ...
                                        <span class="fw-semibold d-flex flex-wrap gap-2">
                                            ...
                                            @if (!empty($order?->latestEditHistory?->order_due_payment_method))
                                                <span
                                                    class="fs-12">({{ translate($order?->latestEditHistory?->order_due_payment_method) }})</span>
                                            @endif
                                            <span
                                                class="badge badge-danger text-bg-danger fw-semibold rounded d-flex align-items-center py-1 px-2 w-max-content">
                                                {{ translate('Unpaid') }}
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column gap-4">
                        ...
                        @if (
                            $editDueAmount > 0 &&
                                $order?->latestEditHistory?->order_due_payment_status === 'unpaid' &&
                                $order?->latestEditHistory?->order_due_payment_method != '')
                        ...
                        @elseif (
                            $editDueAmount > 0 &&
                                !in_array($paymentMethod, ['cash_on_delivery']) &&
                        ...
                        <div class="text-capitalize">
                            ...
                            <div class="select-wrapper">
                                <select name="order_status" id="order_status" class="status form-select"
                                    data-id="{{ $order['id'] }}">
                        ...
                        @if ($physicalProduct || $shippingAddress)
                            <ul class="list-unstyled list-unstyled-py-4 d-flex flex-column gap-4 mb-0 pe-0">
                                <li class="">
                                    ...
                                    @endif
                                    <div class="select-wrapper"
                                        @if ($disableDeliveryType) data-bs-toggle="tooltip"
                                         data-bs-placement="top"
                                         title="{{ translate('You cannot select delivery type as the order only contain digital product') }}" @endif>
                                        <select class="form-select" name="delivery_type" id="choose_delivery_type"
                                ...
                                @if (!$disableDeliveryType)
                                    <li class="choose_delivery_man">
                                        ...
                                        <select class="custom-select" name="delivery_man_id" id="addDeliveryMan"
                                            ...
                                            <div class="p-3 bg-section rounded mt-4">
                                                <div class="media m-1 gap-2 align-items-center">
                                                    <img class="avatar rounded-circle"
                                                        ...
                                                        alt="{{ translate('Image') }}">
                                                    <div class="media-body">
                                                        <div class="fs-12">{{ translate('no_delivery_man_assigned') }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @if (isset($order->deliveryMan))
                                        ...
                                        <li class="choose_delivery_man">
                                            ...
                                            <input type="date" data-order-id="{{ $order['id'] }}"
                                                ...
                                                class="form-control set-today-date-minimum"
                                                {{ $order->order_status == 'delivered' ? 'disabled' : 'required' }}>
                                        </li>
                                    @endif
                        ...
                        <div class="card-body">
                            <div class="d-flex gap-2 align-items-center justify-content-between mb-3">
                                <h4 class="d-flex gap-2 fs-14 fw-bold mb-0">
                                    <img src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/vendor-information.png') }}"
                                        alt="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex gap-2 align-items-center justify-content-between mb-3">
                                ...
                                @if ($order['order_status'] != 'delivered')
                                    <button class="btn btn-outline-primary icon-btn" title="{{ translate('edit') }}"
                            ...
                            <div class="media flex-wrap gap-3 gap-sm-4">
                                ...
                                <div class="media-body d-flex flex-column gap-1">
                                    <a class="text-dark"
                                        ...
                                        target="_blank">
                                        <span
                                            class="fw-semibold">{{ $order->customer['f_name'] . ' ' . $order->customer['l_name'] }}
                                        </span>
                                    </a>

                                    @if ($order?->customer?->email !== 'walking@customer.com')
                                        <span class="text-dark fs-12"> <span class="fw-bold">{{ $orderCount }}</span>
                                            {{ translate('orders') }}</span>
                                        <span class="text-dark break-all fs-12"><span
                        ...
                        <div class="media d-flex gap-3 align-items-center">
                            @if ($order->seller_is == 'admin')
                                ...
                                <div class="media-body d-flex flex-column gap-2">
                                    ...
                                    <span class="text-dark fs-12"><strong>{{ $totalDelivered }}</strong>
                                        ...
                                        @if (getWebConfig('map_api_status') == 1)
                                            <div class="col-12 ">
                                                <input id="billing-pac-input" class="form-control rounded w-200 mt-1"
                                                    title="{{ translate('search_your_location_here') }}" type="text"
                                                    placeholder="{{ translate('search_here') }}" />
                                                <div class="rounded w-100 h-200 mb-2" id="location_map_canvas_billing">
                                                </div>
                                            </div>
                                        @endif
                                        <div class="col-12">
                                        ...
                                        <div class="nav-link active-status">
                                            <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                                                <div class="media-tab-media mx-sm-auto mb-3">
                                                    <img src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/track-order/order-placed.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="media-body">
                                        ...
                                        @if (!$isOrderOnlyDigital)
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                                                        <div class="media-tab-media mb-3 mx-sm-auto">
                                                            <img src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/track-order/order-confirmed.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="media-body">
                                                            <div class="text-sm-center text-start">
                                            ...
                                            <li class="nav-item">
                                                <div
                                                    ...
                                                    <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                                                        <div class="media-tab-media mb-3 mx-sm-auto">
                                                            <img src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/track-order/on-the-way.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="media-body">
                                                            <div class="text-sm-center text-start">
                                            ...
                                            <li class="nav-item">
                                                <div
                                                    ...
                                                    <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                                                        <div class="media-tab-media mb-3 mx-sm-auto">
                                                            <img src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/track-order/delivered.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="media-body">
                                                            <div class="text-sm-center text-start">
                                    ...
                                    @elseif(in_array($order['order_status'], ['returned', 'canceled']))
                                        <li class="nav-item">
                                            <div class="nav-link active-status">
                                                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                                                    <div class="media-tab-media mx-sm-auto mb-3">
                                                        <img src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/track-order/' . $order['order_status'] . '.png') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <div class="text-sm-center text-start">
                                    ...
                                    @else
                                        <li class="nav-item">
                                            <div class="nav-link active-status">
                                                <div class="d-flex flex-sm-column gap-3 gap-sm-0">
                                                    <div class="media-tab-media mx-sm-auto mb-3">
                                                        <img src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/track-order/order-failed.png') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <div class="text-sm-center text-start">
    ...
    <span id="get-search-product-for-edit-order"
        data-action="{{ route('admin.orders.search-for-edit-order-product') }}"
