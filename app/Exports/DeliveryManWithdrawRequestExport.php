...
class DeliveryManWithdrawRequestExport implements FromView, ShouldAutoSize, WithColumnWidths, WithEvents, WithHeadings, WithStyles
{
    use Exportable;
    ...
    {
        return view('file-exports.delivery-man-withdraw-request', [
            'data' => $this->data,
        ]);
    }
