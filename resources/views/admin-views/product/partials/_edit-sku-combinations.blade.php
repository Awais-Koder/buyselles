            ...
            <tbody>
                ...
                @foreach ($combinations as $key => $combination)
                    <tr>
                        ...
                        <td>
                            <label for=""
                                class="control-label text-wrap max-w-250">{{ $combination['type'] }}</label>
                        ...
                        <td>
                            <input type="number" name="price_{{ $combination['type'] }}"
                                ...
                                step="0.01" class="form-control min-w-max-content" required
                                placeholder="{{ translate('ex') . ': 100' }}">
                        </td>
                        <td>
                            <input type="text" name="sku_{{ $combination['type'] }}"
                                value="{{ $combination['sku'] }}"
                                class="form-control min-w-max-content store-keeping-unit" required>
                        </td>
                        <td>
                            <input type="number" name="qty_{{ $combination['type'] }}"
                                value="{{ $combination['qty'] }}" min="0" max="100000" step="1"
                                class="form-control min-w-max-content"
                                placeholder="{{ translate('ex') }}: {{ translate('5') }}" required>
                        </td>
                    </tr>
                @endforeach
            </tbody>
