...
class RestockProductRepository implements RestockProductRepositoryInterface
{
    ...
    public function getListWhereBetween(array $orderBy = [], ?string $searchValue = null, array $filters = [], array $relations = [], ?string $whereBetween = null, array $whereBetweenFilters = [], int|string|null $takeItem = null, int|string $dataLimit = DEFAULT_DATA_LIMIT, ?int $offset = null): Collection|LengthAwarePaginator
    {
        $query = $this->restockProduct
            ->with($relations)
            ->withCount(['restockProductCustomers'])
