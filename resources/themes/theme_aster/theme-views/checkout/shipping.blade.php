                    ...
                    <div class="card h-100">
                        <div class="card-body  px-sm-4">
                            ...
                            {{-- =========================================================
                                 ...
                                 ========================================================= --}}
                            <div class="mt-4 payment-method-list-page" id="payment-methods-section">
                                        ...
                                        @if (auth('customer')->check() && $wallet_status == 1)
                                            <div class="modal fade" id="wallet_submit_button">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">{{ translate('wallet_payment') }}</h5>
                                                        ...
                                                        <form action="{{ route('checkout-complete-wallet') }}" method="get"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-row mb-3">
                                                                    <div class="form-group col-12">
                                                                        <label>{{ translate('your_current_balance') }}</label>
                                                                ...
                                                                <div class="form-row mb-3">
                                                                    <div class="form-group col-12">
                                                                        <label>{{ translate('order_amount') }}</label>
                                                                        <input class="form-control" type="text"
                                                                ...
                                                                <div class="form-row mb-2">
                                                                    <div class="form-group col-12">
                                                                        <label>{{ translate('remaining_balance') }}</label>
                                                                        <input class="form-control" type="text"
                                                                            value="{{ webCurrencyConverter($remain_balance) }}"
                                                                            readonly>
                                                                        @if ($remain_balance < 0)
                                                                            <label class="__color-crimson mt-2">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" data-bs-dismiss="modal"
                                                                    class="update_cart_button fs-16 btn btn-secondary">{{ translate('close') }}</button>
                                                                <button type="submit"
