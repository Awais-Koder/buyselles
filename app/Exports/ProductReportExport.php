...
class ProductReportExport implements FromView, ShouldAutoSize, WithColumnWidths, WithEvents, WithHeadings, WithStyles
{
    use Exportable;
    ...
    {
        return view('file-exports.product-report-export', [
            'data' => $this->data,
        ]);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        return [
            ...
            'A1:H'.($this->data['products']->count() + 3) => [
                'borders' => [
                    'allBorders' => [
