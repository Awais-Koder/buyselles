                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="number" min="0" step="0.01"
                                    placeholder="{{ translate('unit_price') }}" id="unit_price" name="unit_price"
                        ...
                        <div class="col-md-6 col-lg-4 physical_product_show" id="quantity">
                            <div class="form-group mb-0">
                                ...
                                <input type="number" min="0" value={{ $product['current_stock'] }}
                                    ...
                                    id="current_stock" class="form-control only-number-input" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group mb-0">
                                    ...
                                    <select class="custom-select multiple-select2 multiple-select-tax-input"
                                        ...
                                        @foreach ($taxVats as $taxVat)
                                            <option value="{{ $taxVat->id }}"
                                                {{ in_array($taxVat->id, $taxVatIds) ? 'selected' : '' }}>
