                            ...
                            <div class="d-flex flex-wrap gap-3 justify-content-lg-end">
                                ...
                                <div class="position-relative">
                                    ...
                                    @if (
                                        ...
                                        <div class="position-absolute top-n1 inset-inline-end-n1 btn-circle bg-danger border border-white border-2"
                                            style="--size: 12px;"></div>
                                    @endif
                                </div>
                            ...
                            <tbody>
                                @foreach ($products as $key => $product)
                                    <tr>
                                        ...
                                        @php
                                            $isDisabled =
                                                (request()->has('request_status') &&
                                                    request('request_status') === '0') ||
                                                request('request_status') === '2';
                                        @endphp
                                        <td class="text-center">
                                            <div class="" data-bs-toggle="{{ $isDisabled ? 'tooltip' : '' }}"
                                                title="{{ $isDisabled ? translate('Non approved products cannot be featured') : '' }}">
                                                <input type="checkbox"
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                @if ($product['product_type'] == 'digital')
                                                    <a class="btn top01 btn-outline-primary icon-btn"
                                                        title="{{ translate('Upload Codes') }}"
                                                        href="{{ route('admin.products.digital-code-import.product-import', $product['id']) }}">
                                                        <i class="fi fi-sr-upload"></i>
                                                    </a>
                                                    <a class="btn top01 btn-outline-secondary icon-btn"
                                                        title="{{ translate('View Codes') }}"
                                                        href="{{ route('admin.products.digital-code-import.product-codes', $product['id']) }}">
