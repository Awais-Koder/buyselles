<div class="variation_wrapper mt-3 physical_product_show show-for-physical-product">
    <div class="outline-wrapper">
        <div class="card rest-part bg-animate">
            <div
                class="card-header d-flex justify-content-end align-items-center gap-3 border-0 pc-header-ai-btn shadow-none">
                ...
                @if (getActiveAIProviderConfigCache())
                    <button type="button"
                        ...
                        data-route="{{ route('vendor.product.variation-setup-auto-fill') }}" data-lang="en">
            ...
            <div
                class="card-body pt-0 product_variation_content {{ count(json_decode($product['variation'], true) ?? []) > 0 ? '' : 'd--none' }}">
                ...
                <div class="bg-section rounded-10 p-12 p-sm-20">
                    <div class="row gy-2 align-items-end">
                        ...
                        <div class="col-md-12">
                            <div class="row customer-choice-options-container my-0 gy-2"
                                id="customer-choice-options-container">
                                @include('vendor-views.product.partials._choices', [
                                    'choice_no' => json_decode($product['attributes'] ?? 'null'),
                                    'choice_options' =>
                                        json_decode($product['choice_options'] ?? 'null', true) ?? [],
                                ])
                            </div>
                        </div>
                    </div>
                ...
                <div class="sku_combination table-responsive form-group mt-2 max-h-300" id="sku_combination">
                    @include('vendor-views.product.partials._edit-sku-combinations', [
                    ...
                    <input type="checkbox" class="switcher_input product_variation_toggle"
                        @if (
                            $product->product_type == 'digital' &&
                                ($product->digital_product_file_types && count($product->digital_product_file_types) > 0)) checked @endif>
                    <span class="switcher_control"></span>
                </label>
            </div>
