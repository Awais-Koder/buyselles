<div class="col-lg-3">
    ...
    <div class="__customer-sidebar user-profile-aside" id="shop-sidebar">
        ...
        <div>
            ...
            <div>
                <div class="widget-title">
                    <a class="{{ Request::is('user-restock-requests*') ? 'active-menu' : '' }}"
                        href="{{ route('user-restock-requests') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M10 1.66667C5.39733 1.66667 1.66667 5.39733 1.66667 10C1.66667 14.6027 5.39733 18.3333 10 18.3333C14.6027 18.3333 18.3333 14.6027 18.3333 10C18.3333 8.68133 18.018 7.41933 17.458 6.30267L16.1947 7.566L13.3333 4.70467L14.5973 3.44067C13.4807 2.881 12.2187 2.56567 10.9 2.56567C6.92533 2.56567 3.734 5.757 3.734 9.73167C3.734 13.7063 6.92533 16.8977 10.9 16.8977C14.1233 16.8977 16.8333 14.1877 16.8333 10.9643H15.3C15.3 13.835 12.87 16.265 10 16.265C7.13 16.265 4.7 13.835 4.7 10.9643C4.7 8.09367 7.13 5.66367 10 5.66367C11.1427 5.66367 12.2113 6.05733 13.0373 6.784L10 9.82133V3.33333H10Z"
                                fill="currentColor" />
                        </svg>
                        <span class="aside-link">
            ...
            <div>
                <div class="widget-title">
                    <a class="{{ Request::is('chat/vendor') ? 'active-menu' : '' }} {{ Request::is('chat/delivery-man') ? 'active-menu' : '' }}"
                        href="{{ route('chat', ['type' => $business_mode == 'multi' ? 'vendor' : 'delivery-man']) }}">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                fill="none">
