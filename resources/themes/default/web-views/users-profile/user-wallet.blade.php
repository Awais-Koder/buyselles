                                                        ...
                                                        <div class="item">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="mb-2 text-dark">{{ translate('valid_till') }}
                                                                        {{ date('d M, Y', strtotime($bonus->end_date_time)) }}
                                                                    </p>
                                                                </div>
                                                                <div>
                                                                    @if ($bonus->bonus_type == 'percentage')
                                                                        <p>{{ translate('add_fund_to_wallet') }}
                                                                            {{ webCurrencyConverter(amount: $bonus->min_add_money_amount) }}
                                                                            {{ translate('and_enjoy') }}
                                                                            {{ $bonus->bonus_amount }}
                                                                            % {{ translate('bonus') }}</p>
                                                                    @else
                                                                        <p>{{ translate('add_fund_to_wallet') }}
                                                                            {{ webCurrencyConverter(amount: $bonus->min_add_money_amount) }}
                                                                            {{ translate('and_enjoy') }}
                                                                            {{ webCurrencyConverter(amount: $bonus->bonus_amount) }}
                                                                            {{ translate('bonus') }}</p>
                                                                    @endif
                                                                    <p class="fw-bold text-accent mb-0">
                                                                        {{ $bonus->description ? Str::limit($bonus->description, 40) : '' }}
                                                                    </p>
                                                                </div>
                                                                <img class="slider-card-bg-img add-fund-carousel-slider-card-bg"
                                                                    width="50"
                                                    ...
                                                    <div id="add-fund-list-area">
                                                            ...
                                                            <div class="gateways_list">
                                                                ...
                                                                @forelse ($paymentGatewayList as $gateway)
                                                                    <label class="form-check form--check rounded">
                                                                        ...
                                                                        @php
                                                                            $gatewayData = !empty(
                                                                                $gateway->additional_data
                                                                            )
                                                                                ? json_decode($gateway->additional_data)
                                                                                : null;
                                                                            $payment_method_title =
                                                                                $gatewayData->gateway_title ??
                                                                                ucwords(
                                                                                    str_replace(
                                                                                        '_',
                                                                                        ' ',
                                                        ...
                                                        @else
                                                            <h6 class="small text-center">
                                                                {{ translate('no_Payment_Methods_Gateway_found') }}</h6>
                                                        @endif
                                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="">
                                    <div
                                        ...
                                        <h6 class="mb-0 font-bold fs-16 flex-grow-1 w-100">
                                            {{ translate('Transaction_History') }}</h6>
                                                ...
                                                <form action="{{ route('wallet') }}" method="get">
                                                    <button type="button" id="transactionFilterBtn"
                                                        ...
                                                        <span class="position-relative">
                                                            <i
                                                                class="fa fa-filter text--primary {{ $filterCount > 0 ? 'fs-25' : '' }}"></i>
                                                            @if ($filterCount > 0)
                                                        ...
                                                        <div class="p-3 overflow-auto max-h-290px">
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <div class="d-flex flex-column gap-3 transaction_earn_by">
                                                                    ...
                                                                    <label
                                                                        class="d-flex justify-content-between align-items-center">
                                                                        <span>{{ translate('due_payment_for_order') }}</span>
                                                                        <input type="checkbox"
                                                                            class="earn-checkbox border-dark"
                                                                            name="types[]" value="due_payment_for_order"
                                                                            {{ in_array('due_payment_for_order', $transactionTypes) ? 'checked' : '' }}>
                                                                    </label>
                                                                    <label
                                                                        class="d-flex justify-content-between align-items-center">
                                                                        <span>{{ translate('Return_order_amount_by_admin') }}</span>
                                                                        <input type="checkbox"
                                                                            class="earn-checkbox border-dark"
                                                                            name="types[]"
                                                                            value="return_order_amount_by_admin"
                                                                            {{ in_array('return_order_amount_by_admin', $transactionTypes) ? 'checked' : '' }}>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            @foreach ($walletTransactionList as $key => $item)
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="">
                                                            <h6 class="mb-2 d-flex align-items-center gap-8">
                                                                <img src="{{ theme_asset(path: 'public/assets/front-end/img/icons/coin-success.png') }}"
                                                                    width="25" alt="">
                                                            ...
                                                            <h6
                                                                class="text-muted mb-0 small text-capitalize fs-13 font-semibold">
                                                        ...
                                                        <div class="text-end small">
                                                            ...
                                                            @else
                                                                <p class="text-info fs-12 m-0">{{ translate('credit') }}
                                                                </p>
                                                            @endif
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="bg-light my-1 p-3 rounded d-flex justify-content-between g-2">
                                                    <div class="w-100">
                                                        <h6 class="mb-2 d-flex align-items-center gap-8">
                                                            @if ($item['debit'] != 0)
                                                                <img src="{{ theme_asset(path: 'public/assets/front-end/img/icons/coin-danger.png') }}"
                                                                    width="25" alt="">
                                                            @else
                                                                <img src="{{ theme_asset(path: 'public/assets/front-end/img/icons/coin-success.png') }}"
                                                                    width="25" alt="">
                                                        ...
                                                        <h6
                                                            ...
                                                            @if ($item['transaction_type'] == 'add_fund_by_admin')
                                                                ...
                                                                {{ $item['reference'] == 'earned_by_referral' ? '(' . translate($item['reference']) . ')' : '' }}
                                                        ...
                                                        @php $showOrderInfo = in_array($item['transaction_type'], ['order_place', 'order_refund', 'due_payment_for_order']) && !empty($item->order_ids); @endphp
                                                        @if ($showOrderInfo)
                                                            @foreach ($item->order_ids as $orderId)
                                                                @php $relatedOrder = $ordersMap[$orderId] ?? null; @endphp
                                                                @if ($relatedOrder)
                                                                    <p class="mb-0 fs-12 text-muted mt-1">
                                                                        <span
                                                                            class="font-semibold">{{ translate('seller') }}:</span>
                                                                        {{ $relatedOrder->seller_is === 'admin' ? getInHouseShopConfig(key: 'name') : $relatedOrder->seller?->shop?->name ?? getInHouseShopConfig(key: 'name') }}
                                                                    </p>
                                                                    @foreach ($relatedOrder->orderDetails as $detail)
                                                                        @if ($detail->product)
                                                                            <p class="mb-0 fs-12 text-muted">
                                                                                <span
                                                                                    class="font-semibold">{{ translate('product') }}:</span>
                                                                                {{ $detail->product->name }}
                                                                            </p>
                                                                        @endif
                                                                    @endforeach
