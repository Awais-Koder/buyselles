...
function updateDigitalPaymentBg() {
    const wrapper = $(".digital-payment-wrapper");
    const hasVisiblePayment = wrapper.find(".digital-payment:visible").length > 0;
    wrapper.toggleClass("bg--light p-3", hasVisiblePayment);
}
