                ...
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex flex-column gap-1 text-primary">
                        ...
                        <p class="fs-14 fw-semibold mb-0">
                            {{ translate('Find_your_desired_stores_and_shop_your_favourite_products') }}</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <form action="{{ route('vendors') }}" method="get">
                        ...
                        <div class="d-flex align-items-center gap-2 position-relative">
                            <input class="form-control appended-form-control pe-5rem search-page-button-input"
                                type="search" autocomplete="off" placeholder="{{ translate('Search_Store') }}"
                                name="shop_name" value="{{ request('shop_name') }}">
                            <button class="input-group-append-overlay search_button d-md-block search-page-button"
                                data-name="name">
        ...
        <div class="row">
                    ...
                    <div class="pb-0 shop-sidebar-scroll">
                        <div class="d-flex gap-3 flex-column">
                            ...
                            @if (request('product_type') == 'digital')
                                @include(
                                    'web-views.products.partials.vendor-partials._filter-publishing-houses',
                                    [
                                ...
                                @include(
                                    'web-views.products.partials.vendor-partials._filter-product-authors',
                                    [
            ...
            <section class="col-lg-9">
                <div class="row">
                        ...
                        <div class="row mx-n2 __min-h-200px w-100">
                            @foreach ($vendorsList as $vendorItem)
                                <div class="col-lg-4 col-md-6 col-sm-12 px-2 pb-4 text-center">
                                    <a href="{{ route('vendor-shop', ['slug' => $vendorItem['slug']]) }}"
                                        ...
                                        <div class="overflow-hidden other-store-banner">
                                            <img class="w-100 h-100 object-cover" alt=""
                                                src="{{ getStorageImages(path: $vendorItem->banner_full_url, type: 'shop-banner') }}">
                                        </div>
                                        <div class="name-area">
                                            <div class="position-relative">
                                                ...
                                                @if (checkVendorAbility(type: $vendorItemType, status: 'temporary_close', vendor: $vendorItem))
                                                    <span
                                                        class="temporary-closed position-absolute text-center rounded-full p-2">
                                        ...
                                        <div class="info-area">
                                            <div class="info-item">
                                                <h6 class="web-text-primary">
                                                    {{ $vendorItem['products_count'] < 1000 ? $vendorItem['products_count'] : number_format($vendorItem['products_count'] / 1000, 1) . 'K' }}
                                                </h6>
                    ...
                    @else
                        <div class="d-flex flex-column justify-content-center align-items-center text-center text-muted w-100"
                            style="min-height: 400px;">
                            <div class="my-2">
                                <img alt=""
                                    src="{{ theme_asset(path: 'public/assets/front-end/img/media/seller.svg') }}">
                            </div>
