...
return [
    ...
    'Solve_to_verify' => 'Solve to verify',
    'Vendor_Products' => 'Vendor Products',
    ...
    'Thanks_for_the_purchase' => 'Thanks for the purchase',
    'Digital_Code_Import' => 'Digital Code Import',
    'file_field_is_required' => 'File field is required',
    'Digital_Code_Bulk_Import' => 'Digital Code Bulk Import',
    'Expected_File_Format' => 'Expected File Format',
    'Uploading...' => 'Uploading...',
    'Upload_&_Start_Import' => 'Upload & Start Import',
    'Existing_digital_codes_for_matching_products_will_be_overwritten.' => 'Existing digital codes for matching products will be overwritten.',
    'Your_file_has_been_queued_for_processing._You_will_be_notified_by_email_and_dashboard_notification_once_it_is_complete.' => 'Your file has been queued for processing. You will be notified by email and dashboard notification once it is complete.',
    'Download_Template' => 'Download Template',
    'Download_the_Excel_template_that_contains_all_your_digital_products._Fill_in_the' => 'Download the Excel template that contains all your digital products. Fill in the',
    'digital_code_(fill_this)' => 'Digital code (fill this)',
    'column_and_upload_the_file_back.' => 'Column and upload the file back.',
    'Columns:_Product_ID,_Product_Name,_Type,_Has_Code_Already,_digital_code' => 'Columns: Product ID, Product Name, Type, Has Code Already, digital code',
    'Do_NOT_change_the_Product_ID_column' => 'Do NOT change the Product ID column',
    'Rows_with_empty_digital_code_are_skipped' => 'Rows with empty digital code are skipped',
    'Only_digital-type_products_are_included' => 'Only digital-type products are included',
    'Download_Excel_Template' => 'Download Excel Template',
    'Upload_Filled_Excel_File' => 'Upload Filled Excel File',
    'Select_Excel_File' => 'Select Excel File',
    'Accepted:_xlsx,_xls,_csv._Max_size:_10MB' => 'Accepted: xlsx, xls, csv. Max size: 10MB',
    ...
    'Each_code_you_upload_is_added_to_the_pool._Existing_codes_are_not_removed.' => 'Each code you upload is added to the pool. Existing codes are not removed.',
    'Product_Type_' => 'Product Type ',
    'profile_image_is_required' => 'Profile image is required',
    'Search_Tags' => 'Search Tags',
    'Digital_items_are_non-returnable' => 'Digital items are non-returnable',
    'Digital_items_are_non-returnable.' => 'Digital items are non-returnable.',
    'Email_address' => 'Email address',
    'Digital_items_are_delivered_instantly_after_payment._No_shipping_required.' => 'Digital items are delivered instantly after payment. No shipping required.',
    'Your_order_contains_digital_products' => 'Your order contains digital products',
    'Proceed_to_Payment' => 'Proceed to Payment',
    'Secure_&_Encrypted_Code' => 'Secure & Encrypted Code',
    'This_is_your_account_email._You_can_change_it_if_needed.' => 'This is your account email. You can change it if needed.',
    'your@email.com' => 'Your@email.com',
    'Instant_Digital_Delivery' => 'Instant Digital Delivery',
    'Instant_Delivery' => 'Instant Delivery',
    'Your_digital_code(s)_will_be_sent_to_this_email_address.' => 'Your digital code(s) will be sent to this email address.',
    'Min._8_chars_·_uppercase_·_lowercase_·_number_·_special_char_(@,_-,__,_etc.)' => 'Min. 8 chars · uppercase · lowercase · number · special char (@, -,  , etc.)',
    'passwords_must_match_with_confirm_password' => 'Passwords must match with confirm password',
    'You_can_add_more_codes_after_saving_using_the_bulk_import_tool.' => 'You can add more codes after saving using the bulk import tool.',
    'Without_Any_Data' => 'Without Any Data',
    'e.g._XXXX-XXXX-XXXX-XXXX_(optional)' => 'E.g. XXXX-XXXX-XXXX-XXXX (optional)',
    'Setup_Vat_Tax' => 'Setup Vat Tax',
    'employee,_Add' => 'Employee, Add',
    'JPG,_JPEG_or_PNG_Image_size' => 'JPG, JPEG or PNG Image size',
    'Select_Colors' => 'Select Colors',
    'Leave_blank_to_keep_existing_pool_unchanged._For_bulk_upload,_use_the_Import_tool.' => 'Leave blank to keep existing pool unchanged. For bulk upload, use the Import tool.',
    'Enter_a_new_code_to_add_to_the_pool_(e.g._XXXX-XXXX-XXXX-XXXX)' => 'Enter a new code to add to the pool (e.g. XXXX-XXXX-XXXX-XXXX)',
    'Add_Code_to_Pool' => 'Add Code to Pool',
    'Enter_a_code_to_add_it_to_this_product_code_pool._Each_buyer_receives_a_unique_code_from_the_pool.' => 'Enter a code to add it to this product code pool. Each buyer receives a unique code from the pool.',
    'Available' => 'Available',
    'Reserved' => 'Reserved',
    'Edit_&_Approved' => 'Edit & Approved',
    'Optionally_add_one_code_now._Use_the_bulk_import_tool_to_add_multiple_codes_at_once.' => 'Optionally add one code now. Use the bulk import tool to add multiple codes at once.',
    'please_update_product_code' => 'Please update product code',
    'update_your_product_code' => 'Update your product code',
    'Add_First_Code_to_Pool' => 'Add First Code to Pool',
    'Shipping_Cost_is_required!' => 'Shipping Cost is required!',
    ...
    'Required:' => 'Required:',
    'Creating_a_new_product' => 'Creating a new product',
    'Password_must_be_at_least_8_characters_and_contain_uppercase,_lowercase,_a_number,_and_a_special_character_(e.g._@,_-,__)' => 'Password must be at least 8 characters and contain uppercase, lowercase, a number, and a special character (e.g. @, -,  )',
    'View_Codes' => 'View Codes',
    'Processing...' => 'Processing...',
    'Upload_Codes' => 'Upload Codes',
    'Upload_&_Import_Now' => 'Upload & Import Now',
    'All_PINs_are_stored_AES-256_encrypted._They_are_only_decrypted_at_the_moment_of_delivery_to_the_customer.' => 'All PINs are stored AES-256 encrypted. They are only decrypted at the moment of delivery to the customer.',
    'PIN_is_encrypted._Only_revealed_at_time_of_delivery.' => 'PIN is encrypted. Only revealed at time of delivery.',
    'No_expiry' => 'No expiry',
    'Added' => 'Added',
    'Expiry_Date' => 'Expiry Date',
    'Codes_are_added_to_the_pool._Existing_codes_are_NOT_removed.' => 'Codes are added to the pool. Existing codes are NOT removed.',
    'PIN_/_Code' => 'PIN / Code',
    'order_edit_due_payment_message' => 'Order edit due payment message',
    'ex:_2' => 'Ex: 2',
    ...
    'use_the_link_to_reset_your_password_on_our_secure_website.' => 'Use the link to reset your password on our secure website.',
    ...
    'Phone_number_already_has_been_taken' => 'Phone number already has been taken',
    'Password_must_contain_uppercase_lowercase_number_and_special_character' => 'Password must contain uppercase lowercase number and special character',
    'Password_must_be_at_least_8_characters_and_include_uppercase,_lowercase,_number_and_special_character.' => 'Password must be at least 8 characters and include uppercase, lowercase, number and special character.',
    'Social_Media_Link' => 'Social Media Link',
    ...
    'Leave_blank_for_codes_that_do_not_expire.' => 'Leave blank for codes that do not expire.',
    'Codes_past_this_date_are_automatically_removed_from_stock_each_night.' => 'Codes past this date are automatically removed from stock each night.',
    'format:' => 'Format:',
    'Fill:' => 'Fill:',
    '.jpeg,.png,.jpg,.webp_Image_size_:Max_2MB_' => '.jpeg,.png,.jpg,.webp Image size :Max 2MB ',
    'product_id_can_be_used_instead_of_product_name' => 'Product id can be used instead of product name',
    'Restocking_an_existing_product' => 'Restocking an existing product',
    'The_import_runs_in_the_background._You_will_receive_an_email_when_the_job_is_complete.' => 'The import runs in the background. You will receive an email when the job is complete.',
    'Digital_files_are_required!' => 'Digital files are required!',
    'Digital_product_type_is_required!' => 'Digital product type is required!',
    'Minimum_order_quantity_must_be_positive!' => 'Minimum order quantity must be positive!',
    'Minimum_order_quantity_is_required!' => 'Minimum order quantity is required!',
    ...
    'Approved_Products' => 'Approved Products',
    'Category_is_required!' => 'Category is required!',
    'The_file_is_processed_immediately._Results_appear_on_the_next_page.' => 'The file is processed immediately. Results appear on the next page.',
    'Category__is_required!' => 'Category  is required!',
    '.jpeg,.png,.jpg,.webp_Image_size_:Max_2MB' => '.jpeg,.png,.jpg,.webp Image size :Max 2MB',
    'Select_Excel_/_CSV_File' => 'Select Excel / CSV File',
    'Upload_Filled_File' => 'Upload Filled File',
    'No_codes_in_the_pool_yet.' => 'No codes in the pool yet.',
    'All_PINs_are_encrypted_with_AES-256_before_being_saved' => 'All PINs are encrypted with AES-256 before being saved',
    'Serial_Number' => 'Serial Number',
    'Codes_past_expiry_are_removed_from_stock_nightly_at_03:00' => 'Codes past expiry are removed from stock nightly at 03:00',
    'Code_Pool' => 'Code Pool',
    'Duplicate_PINs_and_serial_numbers_are_rejected_automatically' => 'Duplicate PINs and serial numbers are rejected automatically',
    'Expired' => 'Expired',
    'Products_file_is_required' => 'Products file is required',
    'Rows_with_empty_pin_are_skipped' => 'Rows with empty pin are skipped',
    'Download_Spreadsheet_Template' => 'Download Spreadsheet Template',
    'Confirm_your_delivery_email' => 'Confirm your delivery email',
    'Tax_fee' => 'Tax fee',
    ...
    'View_Order_Details' => 'View Order Details',
    'Digital_products_are_non-returnable_and_non-refundable_once_the_code_is_delivered.' => 'Digital products are non-returnable and non-refundable once the code is delivered.',
    'Total_Item_Price' => 'Total Item Price',
    'keep_it_handy_for_tracking.' => 'Keep it handy for tracking.',
    'Download_Invoice' => 'Download Invoice',
    'sort_by_oldest' => 'Sort by oldest',
    'Order_Type' => 'Order Type',
    'Your_Digital_Codes_—_Order_#' => 'Your Digital Codes — Order #',
    'Your_Digital_Codes' => 'Your Digital Codes',
    'Your_Digital_Codes_Are_Ready' => 'Your Digital Codes Are Ready',
    'Your_digital_product_code(s)_for_order' => 'Your digital product code(s) for order',
    'are_included_below._Please_save_them_immediately.' => 'Are included below. Please save them immediately.',
    'Do_not_share_this_email_with_anyone._These_codes_are_for_your_use_only.' => 'Do not share this email with anyone. These codes are for your use only.',
    'You_can_also_view_your_codes_any_time_from_your_order_history.' => 'You can also view your codes any time from your order history.',
    'Expires' => 'Expires',
    'Order_info' => 'Order info',
    'Keep_these_codes_safe._Do_not_share_with_anyone.' => 'Keep these codes safe. Do not share with anyone.',
    ...
    '(or_use_product_id_instead_of_product_name)' => '(or use product id instead of product name)',
    'Upload_More_Codes' => 'Upload More Codes',
    'Leave_expiry_date_blank_for_codes_that_never_expire' => 'Leave expiry date blank for codes that never expire',
    'blank/example_row(s)_skipped' => 'Blank/example row(s) skipped',
    'Excel_Column_Format' => 'Excel Column Format',
    'Each_code_is_added_to_the_pool._Existing_codes_are_NOT_removed.' => 'Each code is added to the pool. Existing codes are NOT removed.',
    'The_green_example_row_in_the_template_is_skipped_automatically' => 'The green example row in the template is skipped automatically',
    'Codes_past_expiry_are_auto-marked_expired_nightly' => 'Codes past expiry are auto-marked expired nightly',
    'expiry_date_format:_YYYY-MM-DD_(e.g._2026-12-31)' => 'Expiry date format: YYYY-MM-DD (e.g. 2026-12-31)',
    'Add_one_code_per_row_and_upload_it_back.' => 'Add one code per row and upload it back.',
    'Download_the_pre-filled_template_for' => 'Download the pre-filled template for',
    'Upload_Digital_Codes' => 'Upload Digital Codes',
    'Digital_Codes' => 'Digital Codes',
    'serial_number_and_expiry_date_are_optional' => 'Serial number and expiry date are optional',
    ...
    'You_cannot_select_delivery_type_as_the_order_only_contain_digital_product' => 'You cannot select delivery type as the order only contain digital product',
    'Reference_Code' => 'Reference Code',
    ...
    'Your_digital_code(s)_will_be_delivered_to_your_email_immediately_after_payment_is_confirmed._No_shipping_address_is_required.' => 'Your digital code(s) will be delivered to your email immediately after payment is confirmed. No shipping address is required.',
    'Invoice_of' => 'Invoice of',
    'Has_Due_Amount' => 'Has Due Amount',
    ...
    'wallet_add_fund' => 'Wallet add fund',
    'Network_error._Please_try_again.' => 'Network error. Please try again.',
    'Decryption_failed' => 'Decryption failed',
    'As_Super_Admin_you_can_reveal_any_PIN_on_demand_using_the_eye_icon.' => 'As Super Admin you can reveal any PIN on demand using the eye icon.',
    'New_products:_fill_product_name_+_price_+_category_id_+_pin' => 'New products: fill product name + price + category id + pin',
    'All_PINs_are_stored_AES-256_encrypted._Serial_numbers_are_stored_as_plain_text._PINs_are_only_decrypted_at_the_moment_of_delivery_to_the_customer.' => 'All PINs are stored AES-256 encrypted. Serial numbers are stored as plain text. PINs are only decrypted at the moment of delivery to the customer.',
    'Reveal_decrypted_PIN_(Super_Admin_only)' => 'Reveal decrypted PIN (Super Admin only)',
    'You_can_reveal_any_PIN_on_demand_using_the_eye_icon.' => 'You can reveal any PIN on demand using the eye icon.',
    'Reveal_decrypted_PIN' => 'Reveal decrypted PIN',
    'PIN_is_AES-256_encrypted._Only_revealed_at_delivery.' => 'PIN is AES-256 encrypted. Only revealed at delivery.',
    'view_encrypted_pin' => 'View encrypted pin',
    ...
    'are_you_sure_this_will_delete_all_cities_and_areas_under_this_country' => 'Are you sure this will delete all cities and areas under this country',
    ...
    'select_city' => 'Select city',
    'Est._Days' => 'Est. Days',
    'Service_areas_and_shipping_rates_updated_successfully' => 'Service areas and shipping rates updated successfully',
    'service_areas' => 'Service areas',
    'Service_Areas_&_Shipping_Rates' => 'Service Areas & Shipping Rates',
    'Select_the_areas_where_you_deliver_products_and_set_shipping_costs_for_each_area.' => 'Select the areas where you deliver products and set shipping costs for each area.',
    'areas' => 'Areas',
    'Area' => 'Area',
    'manage_cities' => 'Manage cities',
    'city_name' => 'City name',
    'if_disabled_this_country_will_be_hidden_from_location_selection' => 'If disabled this country will be hidden from location selection',
    'Select_the_areas_where_you_deliver_products.' => 'Select the areas where you deliver products.',
    'Invoice_Date' => 'Invoice Date',
    'Thank_You_For_Your_Purchase!' => 'Thank You For Your Purchase!',
    'Serial' => 'Serial',
    'INVOICE' => 'INVOICE',
    ...
    'select_a_withdrawal_method_from_the_available_options_and_fill_in_the_required_details_to_send_your_withdraw_request.' => 'Select a withdrawal method from the available options and fill in the required details to send your withdraw request.',
    'Withdraw_method_list' => 'Withdraw method list',
    ...
    'Withdraw_information_View' => 'Withdraw information View',
    'new_physical_order' => 'New physical order',
    'new_message(s)' => 'New message(s)',
    'You_have' => 'You have',
    ...
    'wallet_and_withdraw' => 'Wallet and withdraw',
    'coupon_management' => 'Coupon management',
    'reviews_and_ratings' => 'Reviews and ratings',
    'customer_management' => 'Customer management',
    'when_all_modules_are_selected,_this_equals_full_access' => 'When all modules are selected, this equals full access',
    'grant_full_access_(select_all)' => 'Grant full access (select all)',
    'check_the_modules_this_vendor_is_allowed_to_access._Unchecked_modules_will_be_blocked._If_all_are_checked,_the_vendor_has_full_access.' => 'Check the modules this vendor is allowed to access. Unchecked modules will be blocked. If all are checked, the vendor has full access.',
    ...
    'you_have_new_product_requests' => 'You have new product requests',
    'Physical_items_in_your_order_will_be_shipped_separately.' => 'Physical items in your order will be shipped separately.',
    ...
    'If_you_want_to_add_fund_to_your_wallet_then_click_add_fund_button' => 'If you want to add fund to your wallet then click add fund button',
    'Same_as_shipping_address' => 'Same as shipping address',
    'No_digital_codes_available' => 'No digital codes available',
    'Enter_your_bank_account' => 'Enter your bank account',
    'No_Codes_Available' => 'No Codes Available',
    'code(s)_skipped_—_duplicate_PIN_or_serial_number_already_exists_in_the_system.' => 'Code(s) skipped — duplicate PIN or serial number already exists in the system.',
    'Copied!' => 'Copied!',
    'Close_(save_codes_first)' => 'Close (save codes first)',
    'I_confirm_I_have_successfully_copied_/_saved_my_code(s)' => 'I confirm I have successfully copied / saved my code(s)',
    'Copy_or_print_your_codes_below._They_are_also_sent_to_your_email.' => 'Copy or print your codes below. They are also sent to your email.',
    'Important' => 'Important',
    'Sold_Codes' => 'Sold Codes',
    'Existing_products:_fill_product_name_+_pin_(product_id_also_accepted)' => 'Existing products: fill product name + pin (product id also accepted)',
    ...
    'Request_failed._Please_try_again.' => 'Request failed. Please try again.',
    'Reveal_/_Hide' => 'Reveal / Hide',
    'Actions' => 'Actions',
    'Code_(masked)' => 'Code (masked)',
    'Assigned_At' => 'Assigned At',
    'Customer_Profile' => 'Customer Profile',
    'Search_by_customer_name,_email,_product_name,_or_order_ID…' => 'Search by customer name, email, product name, or order ID…',
    'Track_which_code_was_delivered_to_which_customer._Click_any_row_item_to_go_to_its_details.' => 'Track which code was delivered to which customer. Click any row item to go to its details.',
    'Sold_Digital_Codes' => 'Sold Digital Codes',
    'Sold_Digital_Codes_—_Tracking' => 'Sold Digital Codes — Tracking',
    ...
    'No_sold_codes_yet.' => 'No sold codes yet.',
    'section.' => 'Section.',
    ...
    'if_enabled_this_country_will_be_available_for_location_selection' => 'If enabled this country will be available for location selection',
    'Added_on_top_of_order_total_and_visible_to_the_customer_at_checkout.' => 'Added on top of order total and visible to the customer at checkout.',
    'e.g._2' => 'E.g. 2',
    'Percent:_charges_X%_of_order_total._Flat:_charges_fixed_amount_per_order.' => 'Percent: charges X% of order total. Flat: charges fixed amount per order.',
    'Customer_Service_Fee_(shown_at_checkout_as_Service_Fee)' => 'Customer Service Fee (shown at checkout as Service Fee)',
    'service_fee' => 'Service fee',
    'You_can_also_retrieve_your_code(s)_anytime_from_Order_Summary_section.' => 'You can also retrieve your code(s) anytime from Order Summary section.',
    ...
    'Codes_past_their_expiry_date_will_be_removed_from_stock_automatically' => 'Codes past their expiry date will be removed from stock automatically',
    'Are_you_sure_you_want_to_delete_this_code?_This_action_cannot_be_undone.' => 'Are you sure you want to delete this code  This action cannot be undone.',
    'Delete_failed' => 'Delete failed',
    'Toggle_failed' => 'Toggle failed',
    'Cannot_delete_reserved_or_sold_codes' => 'Cannot delete reserved or sold codes',
    'This_action_cannot_be_undone' => 'This action cannot be undone',
    'Delete_this_code' => 'Delete this code',
    'Code_deleted_successfully' => 'Code deleted successfully',
    'Cannot_toggle_reserved_or_sold_codes' => 'Cannot toggle reserved or sold codes',
    'Code_deactivated_successfully' => 'Code deactivated successfully',
    'Code_activated_successfully' => 'Code activated successfully',
    'Existing_products:_fill_in_product_name_+_pin._product_id_also_accepted.' => 'Existing products: fill in product name + pin. product id also accepted.',
    'Employee_Identity_Image' => 'Employee Identity Image',
    'modules_enabled' => 'Modules enabled',
    'manage_vendor_permissions' => 'Manage vendor permissions',
    'vendor_permissions_updated_successfully' => 'Vendor permissions updated successfully',
    'Percent:_deducts_X%_of_order_total._Flat:_deducts_fixed_amount_per_order.' => 'Percent: deducts X% of order total. Flat: deducts fixed amount per order.',
    'Give_Review' => 'Give Review',
    'e.g._5' => 'E.g. 5',
    'country_list' => 'Country list',
    'area_name' => 'Area name',
    'Your_support_ticket_has_been_submitted_successfully_Our_team_will_respond_shortly' => 'Your support ticket has been submitted successfully Our team will respond shortly',
    'Partner_request' => 'Partner request',
    'Support_ticket_status_updated' => 'Support ticket status updated',
    'Ticket_Submitted' => 'Ticket Submitted',
    'New_Support_Ticket_Submitted' => 'New Support Ticket Submitted',
    'New_Ticket' => 'New Ticket',
    'A_new_support_ticket_has_been_submitted' => 'A new support ticket has been submitted',
    'ticket_id' => 'Ticket id',
    'View_Ticket' => 'View Ticket',
    'The_file_must_be_of_type:_jpeg,_png,_jpg,_gif' => 'The file must be of type: jpeg, png, jpg, gif',
    'New_support_ticket_from' => 'New support ticket from',
    ...
    'Country_Name' => 'Country Name',
    'e.g._United_States' => 'E.g. United States',
    'Country_Code' => 'Country Code',
    'e.g._US' => 'E.g. US',
    'City_Name' => 'City Name',
    'e.g._New_York' => 'E.g. New York',
    'Area_Name' => 'Area Name',
    'e.g._Manhattan' => 'E.g. Manhattan',
    'Loading...' => 'Loading...',
    'Saving...' => 'Saving...',
    ...
    'e.g._SA' => 'E.g. SA',
    'are_you_sure_this_will_delete_all_areas_under_this_city' => 'Are you sure this will delete all areas under this city',
    ...
    'Add_countries,_cities_&_areas' => 'Add countries, cities & areas',
    'e.g._Saudi_Arabia' => 'E.g. Saudi Arabia',
    'Add_Country' => 'Add Country',
    'e.g._Riyadh' => 'E.g. Riyadh',
    'Add_City' => 'Add City',
    'e.g._Al_Olaya' => 'E.g. Al Olaya',
    'COD_Available' => 'COD Available',
    ...
    'all_cities' => 'All cities',
    'all_countries' => 'All countries',
    'Area_is_required_for_physical_products!' => 'Area is required for physical products!',
    'City_is_required_for_physical_products!' => 'City is required for physical products!',
    'area_is_required_for_physical_products!' => 'Area is required for physical products!',
    'city_is_required_for_physical_products!' => 'City is required for physical products!',
    ...
    'edit_city' => 'Edit city',
    'edit_area' => 'Edit area',
    'no_city_requests_found' => 'No city requests found',
    'Submit_Request' => 'Submit Request',
    'city_request_submitted_for_admin_approval' => 'City request submitted for admin approval',
    'optional_reason_for_rejection' => 'Optional reason for rejection',
    'requested_city' => 'Requested city',
    'Submitting...' => 'Submitting...',
    'City_Request_Pending' => 'City Request Pending',
    'product_will_go_to_admin_review_until_city_is_approved' => 'This product will be placed under admin review until the requested city is approved.',
    'Global' => 'Global',
    'reject_city_request' => 'Reject city request',
    'Commission_deducted_from_vendor_payout._Not_visible_to_customers.' => 'Commission deducted from vendor payout. Not visible to customers.',
    'location_Setup' => 'Location Setup',
    'search_by_city_name' => 'Search by city name',
    'all_statuses' => 'All statuses',
    'if_the_city_you_need_is_not_listed_request_admin_to_add_it' => 'If the city you need is not listed request admin to add it',
    'Request_New_City' => 'Request New City',
    'Request_city' => 'Request city',
    'Area_added_successfully' => 'Area added successfully',
    'store_area' => 'Store area',
    'store_city' => 'Store city',
    'store_country' => 'Store country',
    'The_selected_area_is_invalid' => 'The selected area is invalid',
    'The_selected_city_is_invalid' => 'The selected city is invalid',
    'Vendor_Commission_(deducted_from_vendor_earnings)' => 'Vendor Commission (deducted from vendor earnings)',
    'countries' => 'Countries',
    'deleted_vendor' => 'Deleted vendor',
    'vendor_city_requests' => 'Vendor city requests',
    'city_requests' => 'City requests',
    ...
    'if_disabled_this_area_will_be_hidden_from_location_selection' => 'If disabled this area will be hidden from location selection',
    'if_enabled_this_area_will_be_available_for_location_selection' => 'If enabled this area will be available for location selection',
    'area_list' => 'Area list',
    'product_will_go_to_admin_review_until_area_is_approved' => 'Product will go to admin review until area is approved',
    'area_request_submitted_for_admin_approval' => 'Area request submitted for admin approval',
    'Area_Requests' => 'Area Requests',
    'area_request_approved_and_area_created' => 'Area request approved and area created',
    'area_requests' => 'Area requests',
    'vendor_area_requests' => 'Vendor area requests',
    ...
    'for_webhook_signature_verification' => 'For webhook signature verification',
    ...
    'no_supplier_orders_found' => 'No supplier orders found',
    ...
    'customer_account_that_owns_this_key' => 'Customer account that owns this key',
    'api_keys' => 'Api keys',
    ...
    'enter_new_value_or_leave_blank' => 'Enter new value or leave blank',
    'supplier_updated_successfully' => 'Supplier updated successfully',
    'set' => 'Set',
    'leave_blank_to_keep_existing_credentials' => 'Leave blank to keep existing credentials',
    ...
    'e_g_partner_name_api' => 'E g partner name api',
    'rate_limiting_description' => 'Rate limiting description',
    'key_name' => 'Key name',
    ...
    'revoke' => 'Revoke',
    'never' => 'Never',
    'reason_visible_to_vendor' => 'Reason visible to vendor',
    'reason' => 'Reason',
    'reseller_api_keys' => 'Reseller api keys',
    'search_by_name_or_user' => 'Search by name or user',
    'api_docs' => 'Api docs',
    'generate_new_key' => 'Generate new key',
    'requests' => 'Requests',
    'last_used' => 'Last used',
    'no_api_keys_found' => 'No api keys found',
    'approve_api_key' => 'Approve api key',
    'approving_key' => 'Approving key',
    'admin_note' => 'Admin note',
    'optional_note_to_vendor' => 'Optional note to vendor',
    'reject_api_key' => 'Reject api key',
    'rejecting_key' => 'Rejecting key',
    'Developer_API' => 'Developer API',
    'this_will_permanently_revoke_your_api_key' => 'This will permanently revoke your api key',
    'check_wallet_balance' => 'Check wallet balance',
    'view_order_status_and_codes' => 'View order status and codes',
    'no_api_logs_found' => 'No api logs found',
    'place_orders' => 'Place orders',
    'list_products_and_stock' => 'List products and stock',
    'vendor_request_note' => 'Vendor request note',
    'view_logs' => 'View logs',
    'this_action_cannot_be_undone' => 'This action cannot be undone',
    'response_ms' => 'Response ms',
    'delete_key' => 'Delete key',
    'quick_actions' => 'Quick actions',
    'deactivate_key' => 'Deactivate key',
    'total_requests' => 'Total requests',
    'hidden_for_security' => 'Hidden for security',
    'key_details' => 'Key details',
    'owner' => 'Owner',
    'ip_whitelist_help' => 'Ip whitelist help',
    'IPs' => 'IPs',
    'ip_whitelist' => 'Ip whitelist',
    'permissions_help' => 'Permissions help',
    'api_permissions' => 'Api permissions',
    'internal_note_optional' => 'Internal note optional',
    'rate_limit_help' => 'Rate limit help',
    ...
    'leave_empty_to_allow_all_ips_one_ip_per_line' => 'Leave empty to allow all ips one ip per line',
    'activate_key' => 'Activate key',
    'revoke_key' => 'Revoke key',
    'API_key' => 'API key',
    'requests_per_minute' => 'Requests per minute',
    'your_raw_api_key_is_not_shown_here_for_security_if_you_have_lost_it_revoke_and_request_a_new_one' => 'Your raw api key is not shown here for security if you have lost it revoke and request a new one',
    'yes_revoke_it' => 'Yes revoke it',
    'yes_regenerate' => 'Yes regenerate',
    'any_integration_using_the_old_key_will_stop_working_immediately' => 'Any integration using the old key will stop working immediately',
    'this_will_invalidate_your_current_api_key_and_secret' => 'This will invalidate your current api key and secret',
    'regenerate_api_key' => 'Regenerate api key',
    'regenerate_key' => 'Regenerate key',
    'credentials_are_hidden_use_regenerate_to_get_new_ones' => 'Credentials are hidden use regenerate to get new ones',
    'api_credentials' => 'Api credentials',
    'yes_remove_it' => 'Yes remove it',
    'no_ips_saved_all_ips_are_allowed' => 'No ips saved all ips are allowed',
    'add_ip_address' => 'Add ip address',
    'current_whitelist' => 'Current whitelist',
    'accepted_formats' => 'Accepted formats',
    'developer_api' => 'Developer api',
    'i_have_saved_my_credentials' => 'I have saved my credentials',
    'submit_request' => 'Submit request',
    'briefly_describe_how_you_plan_to_use_the_api' => 'Briefly describe how you plan to use the api',
    'show_hide' => 'Show hide',
    'your_api_key_request_is_pending_admin_approval' => 'Your api key request is pending admin approval',
    'deactivate' => 'Deactivate',
    'approved_at' => 'Approved at',
    'these_credentials_are_shown_only_once_and_cannot_be_recovered_store_them_securely' => 'These credentials are shown only once and cannot be recovered store them securely',
    'when' => 'When',
    'time_ms' => 'Time ms',
    ...
    'api_key_disabled_or_ip_not_whitelisted' => 'Api key disabled or ip not whitelisted',
    'platform_order' => 'Platform order',
    'deleted' => 'Deleted',
    'response_payload' => 'Response payload',
    'request_payload' => 'Request payload',
    'reseller_api_documentation' => 'Partner API Documentation',
    'partner_api_docs_description' => 'Complete reference for integrating with the Buyselles Partner API.',
    'reseller_api_overview_text' => 'The Buyselles Partner API allows approved partners to fetch products, check stock, and place orders programmatically. All responses are JSON. The current version is v1.',
    'reseller_auth_description' => 'All requests must be authenticated using an API key and secret issued from your Developer dashboard. Keys must be approved by an admin before use.',
    'list_available_products' => 'List available products',
    'get_product_details' => 'Get product details',
    'get_order_status' => 'Get order status and codes',
    'products_endpoint_description' => 'Returns all admin-approved digital ready-stock products with real-time available stock counts.',
    'product_detail_endpoint_description' => 'Returns full details for a single product including real-time stock count and description.',
    'create_order_endpoint_description' => 'Places an order, immediately debits the partner wallet, assigns digital codes, and returns them in the response.',
    'order_status_endpoint_description' => 'Returns order details and all assigned codes. Only orders placed by your own API key are accessible.',
    'balance_endpoint_description' => 'Returns the current wallet balance for this API key.',
    'back_to_keys' => 'Back to keys',
    'filter_by_product_name' => 'Filter by product name (partial match)',
    'filter_by_category' => 'Filter by category ID',
    'page_number_default_1' => 'Page number (default: 1)',
    'items_per_page_default_20_max_100' => 'Items per page (default: 20, max: 100)',
    'id_from_products_list' => 'Product ID from the products list',
    'number_of_codes_1_to_100' => 'Number of codes to purchase (1–100)',
    'your_internal_reference_for_tracking' => 'Your own reference string for tracking (optional)',
    'missing_api_credentials_headers' => 'X-API-KEY and/or X-API-SECRET headers are missing',
    'invalid_api_key_or_secret' => 'API key not found or secret does not match',
    'insufficient_wallet_balance' => 'Partner wallet balance is too low to cover the order',
    'idempotency' => 'Idempotency',
    'idempotency_description' => 'To prevent double-charging on network retries, include an X-Idempotency-Key header on every POST /orders request. If a request with the same key is received again, the original response is returned — no new order is created and no balance is deducted.',
    'escrow' => 'Escrow (48-Hour Hold)',
    'escrow_description' => "Funds from every partner order are held in the vendor's pending balance for 48 hours after the order is placed. This window allows time for any dispute before the funds are released to the vendor's available balance. The balance deduction from the partner wallet is immediate.",
    'ip_whitelist_behavior' => 'IP Whitelist Behavior',
    'ip_whitelist_behavior_description' => 'If no IPs are added to the whitelist, all IPs are permitted (open mode — useful during development). Once any IP is added, only those specific IPs are allowed. All others receive a 403 response.',
    'http_status' => 'Http status',
    'auth_type' => 'Auth type',
    'product_supplier_mappings' => 'Product supplier mappings',
    ...
    'supplier_api_logs' => 'Supplier api logs',
    'supplier_API_logs' => 'Supplier API logs',
    'success' => 'Success',
    'HTTP_code' => 'HTTP code',
    'detail' => 'Detail',
    ...
    'add_product_mapping' => 'Add product mapping',
    'add_product_supplier_mapping' => 'Add product supplier mapping',
    'select_supplier' => 'Select supplier',
    'supplier_product_id_SKU' => 'Supplier product id SKU',
    'supplier_product_name' => 'Supplier product name',
    'optional_cached_name' => 'Optional cached name',
    'cost_price' => 'Cost price',
    'markup_type' => 'Markup type',
    'markup_value' => 'Markup value',
    'min_stock_threshold' => 'Min stock threshold',
    'auto_restock_when_below_this' => 'Auto restock when below this',
    'max_restock_quantity' => 'Max restock quantity',
    'edit_supplier' => 'Edit supplier',
    'base_url' => 'Base url',
    'If_disabled_this_supplier_will_not_be_used_for_any_order_fulfillment' => 'If disabled this supplier will not be used for any order fulfillment',
    'If_enabled_this_supplier_will_be_used_for_automatic_code_fulfillment' => 'If enabled this supplier will be used for automatic code fulfillment',
    'Want_to_Turn_OFF_Supplier_Status' => 'Want to Turn OFF Supplier Status',
    'Want_to_Turn_ON_Supplier_Status' => 'Want to Turn ON Supplier Status',
    'Want_to_Turn_ON_Mapping_Status' => 'Want to Turn ON Mapping Status',
    'Want_to_Turn_OFF_Mapping_Status' => 'Want to Turn OFF Mapping Status',
    'If_enabled_this_supplier_mapping_will_be_used_for_stock_fulfillment' => 'If enabled, this mapping will be used for stock fulfillment',
    'If_disabled_this_mapping_will_not_be_used_for_any_stock_fulfillment' => 'If disabled, this mapping will not be used for any stock fulfillment',
    'browse_catalog' => 'Browse catalog',
    'browse_supplier_catalog' => 'Browse supplier catalog',
    'no_products_found' => 'No products found',
    'loading_catalog' => 'Loading catalog',
    'failed_to_load_catalog' => 'Failed to load catalog. Please try again.',
    ...
    'mapping_updated_successfully' => 'Mapping updated successfully',
    'checking_catalog' => 'Checking catalog',
    'select_driver' => 'Select driver',
    'catalog_sync_failed' => 'Catalog sync failed',
    'sync_complete_loading' => 'Sync complete loading',
    'syncing_catalog' => 'Syncing catalog',
    'failed_to_start_sync' => 'Failed to start sync',
    'failed_to_dispatch_price_sync' => 'Failed to dispatch price sync',
    'price_sync_dispatched_successfully' => 'Price sync dispatched successfully',
    'sync_prices' => 'Sync prices',
    'Failed_to_update_Partner_API_approval' => 'Failed to update Partner API approval',
    'Partner_API' => 'Partner API',
    'Product_approved_for_Partner_API' => 'Product approved for Partner API',
    'price_sync_already_running' => 'Price sync already running',
    'failed_to_check_sync_status' => 'Failed to check sync status',
    'synced' => 'Synced',
    ...
    'maximum_value_the_customer_can_enter' => 'Maximum value the customer can enter',
    'maximum_amount' => 'Maximum amount',
    'enter_your_desired_amount_between_the_range' => 'Enter your desired amount between the range',
    'minimum_value_the_customer_can_enter' => 'Minimum value the customer can enter',
    ...
    'when_enabled_customer_can_enter_a_custom_amount_instead_of_a_fixed_denomination' => 'When enabled customer can enter a custom amount instead of a fixed denomination',
    'customizable_variable_amount' => 'Customizable variable amount',
    'variable_amount_settings' => 'Variable amount settings',
    'mapping_deleted_successfully' => 'Mapping deleted successfully',
    'denomination' => 'Denomination',
    'failed_to_sync_prices' => 'Failed to sync prices',
    'sync_completed' => 'Sync completed',
    'sync_request_timed_out_please_try_again' => 'Sync request timed out please try again',
    'price_sync_completed_successfully' => 'Price sync completed successfully',
    ...
    'Search_by_dispute_#_or_order_#' => 'Search by dispute # or order #',
    'Vendor_Responded' => 'Vendor Responded',
    'Resolved:_Refund' => 'Resolved: Refund',
    'Resolved:_Released' => 'Resolved: Released',
    'Closed' => 'Closed',
    'Dispute_#' => 'Dispute #',
    'Order_#' => 'Order #',
    'Buyer' => 'Buyer',
    ...
    'Filter_Disputes' => 'Filter Disputes',
    'All_Priorities' => 'All Priorities',
    'Critical' => 'Critical',
    'From_Date' => 'From Date',
    'Yes,_Release' => 'Yes, Release',
    'You_are_about_to_manually_release_escrow_funds.' => 'You are about to manually release escrow funds.',
    'Held' => 'Held',
    'Disputed' => 'Disputed',
    'Total_Held_Amount' => 'Total Held Amount',
    'Escrow_Records' => 'Escrow Records',
    'Search_by_order_#' => 'Search by order #',
    'Refunded' => 'Refunded',
    'Escrow_#' => 'Escrow #',
    'Dispute' => 'Dispute',
    'Auto_Release' => 'Auto Release',
    'No_escrow_records_found' => 'No escrow records found',
    'Are_you_sure?' => 'Are you sure ',
    'Total_Held' => 'Total Held',
    'Pending_Refund_Requests_List' => 'Pending Refund Requests List',
    'Flash_Deal_Add' => 'Flash Deal Add',
    'Escrow_Settings' => 'Escrow Settings',
    'Save_Settings' => 'Save Settings',
    'Funds_auto-release_to_vendor_after_this_many_hours_if_no_dispute_is_opened.' => 'Funds auto-release to vendor after this many hours if no dispute is opened.',
    'Auto_Release_After_(Hours)' => 'Auto Release After (Hours)',
    'Escrow_Protection' => 'Escrow Protection',
    'When_enabled,_vendor_earnings_are_held_in_escrow_until_buyer_confirms_receipt_or_auto-release_period_expires.' => 'When enabled, vendor earnings are held in escrow until buyer confirms receipt or auto-release period expires.',
    'escrow_settings_updated_successfully' => 'Escrow settings updated successfully',
    'You_are_about_to_manually_release_escrow_funds_to_the_vendor._This_cannot_be_undone.' => 'You are about to manually release escrow funds to the vendor. This cannot be undone.',
    'Escrow_protection_only_applies_to_third-party_vendor_orders_with_online_or_wallet_payments._COD_and_offline_payments_are_excluded.' => 'Escrow protection only applies to third-party vendor orders with online or wallet payments. COD and offline payments are excluded.',
    'All_Disputes' => 'All Disputes',
    'escrow_released_successfully' => 'Escrow released successfully',
    'Linked_Order' => 'Linked Order',
    'Release_Funds_Now' => 'Release Funds Now',
    'description_must_not_exceed_2000_characters' => 'Description must not exceed 2000 characters',
    'description_must_be_at_least_20_characters' => 'Description must be at least 20 characters',
    'dispute_opened_successfully' => 'Dispute opened successfully',
    'dispute_not_found' => 'Dispute not found',
    'dispute_not_found_or_closure_not_pending' => 'Dispute not found or closure is not pending',
    'dispute_closed_successfully' => 'Dispute closed successfully',
    'dispute_escalated_to_admin' => 'Dispute escalated to admin',
    'dispute_escalated_to_admin_for_review_by' => 'Dispute escalated to admin for review by',
    'dispute_cannot_be_escalated_in_current_status' => 'Dispute cannot be escalated in the current status',
    'dispute_is_already_closed' => 'Dispute is already closed',
    'message_sent_successfully' => 'Message sent successfully',
    'you_are_not_authorized_to_dispute_this_order' => 'You are not authorized to dispute this order',
    'order_id_is_required' => 'Order id is required',
    'Manual_release_is_blocked_while_a_dispute_is_active.' => 'Manual release is blocked while a dispute is active.',
    'System' => 'System',
    'Close_Without_Resolution' => 'Close Without Resolution',
    'Reason_for_closing_(optional)' => 'Reason for closing (optional)',
    'resolved_refund' => 'Resolved refund',
    'This_dispute_has_been_resolved.' => 'This dispute has been resolved.',
    'Resolve:_Release_to_Vendor' => 'Resolve: Release to Vendor',
    'resolved_release' => 'Resolved release',
    'Status_History' => 'Status History',
    'Reason' => 'Reason',
    'Escrow' => 'Escrow',
    'Funds_will_be_automatically_released_to_the_vendor_after_this_many_hours_if_no_dispute_is_opened.' => 'Funds will be automatically released to the vendor after this many hours if no dispute is opened.',
    'When_enabled,_escrow_protection_will_apply_to_orders_containing_digital_products_(gift_cards,_game_keys,_codes,_etc.).' => 'When enabled, escrow protection will apply to orders containing digital products (gift cards, game keys, codes, etc.).',
    'my_disputes' => 'My disputes',
    'open_dispute' => 'Open dispute',
    'order_items' => 'Order items',
    'submit_dispute' => 'Submit dispute',
    'dispute_flow_explanation' => 'Dispute flow explanation',
    'exceeds' => 'Exceeds',
    'yes_escalate' => 'Yes escalate',
    'escalate_to_admin_confirm_text' => 'This will escalate the dispute to an admin for review. Once escalated, the admin will investigate and make a final decision.',
    'Explain_your_decision...' => 'Explain your decision...',
    'Resolve:_Refund_Buyer' => 'Resolve: Refund Buyer',
    'Decision_/_Admin_Note' => 'Decision / Admin Note',
    'Mark_Under_Review' => 'Mark Under Review',
    'Admin_Actions' => 'Admin Actions',
    'view_dispute' => 'View dispute',
    'escalate_to_admin_confirm_title' => 'Escalate to Admin?',
    'back_to_my_disputes' => 'Back to my disputes',
    'upload_files' => 'Upload files',
    'Dispute_Info' => 'Dispute Info',
    'jpg_png_mp4_max_5_images_5MB_each_video_50MB' => 'Jpg png mp4 max 5 images 5MB each video 50MB',
    'buyer' => 'Buyer',
    'open_a_dispute_to_get_help' => 'Open a dispute to get help',
    'maximum_5_files_allowed' => 'Maximum 5 files allowed',
    'upload_evidence' => 'Upload evidence',
    'No_evidence_uploaded_yet' => 'No evidence uploaded yet',
    'file(s)' => 'File(s)',
    'Open_full_size' => 'Open full size',
    'Evidence' => 'Evidence',
    'Type_a_message_to_the_buyer_or_vendor...' => 'Type a message to the buyer or vendor...',
    'Dispute_Details' => 'Dispute Details',
    'under_review' => 'Under review',
    'Digital_code_invalid_or_already_used' => 'Digital code invalid or already used',
    'dispute_opened' => 'Dispute opened',
    'have_an_issue_with_this_order' => 'Have an issue with this order',
    'how_disputes_work' => 'How disputes work',
    'no_evidence_uploaded_yet' => 'No evidence uploaded yet',
    'evidence' => 'Evidence',
    'disputes_are_not_available_for_cod_orders' => 'Disputes are not available for cod orders',
    'videos_max_50MB' => 'Videos max 50MB',
    'send_message' => 'Send message',
    'Apply_Escrow_to_Digital_Products' => 'Apply Escrow to Digital Products',
    'When_enabled,_escrow_protection_will_apply_to_orders_containing_physical_(tangible)_products.' => 'When enabled, escrow protection will apply to orders containing physical (tangible) products.',
    'Apply_Escrow_to_Physical_Products' => 'Apply Escrow to Physical Products',
    'you' => 'You',
    'Customers_can_only_open_a_dispute_within_this_many_days_after_order_delivery._After_this_period,_disputes_are_no_longer_allowed.' => 'Customers can only open a dispute within this many days after order delivery. After this period, disputes are no longer allowed.',
    'Dispute_Window_After_Delivery' => 'Dispute Window After Delivery',
    'images_max_5MB' => 'Images max 5MB',
    'max_5_files' => 'Max 5 files',
    'Hours' => 'Hours',
    'accepted_jpg_png_mp4' => 'Accepted jpg png mp4',
    'please_describe_the_issue_in_detail_minimum_20_characters' => 'Please describe the issue in detail minimum 20 characters',
    'describe_the_issue' => 'Describe the issue',
    'Auto_Release_After' => 'Auto Release After',
    'Wrong_item_received' => 'Wrong item received',
    'Escrow_Protection_Status' => 'Escrow Protection Status',
    'Product_not_as_described' => 'Product not as described',
    'Item_damaged_on_arrival' => 'Item damaged on arrival',
    'Configure_escrow_protection_to_hold_vendor_earnings_until_the_buyer_confirms_receipt_or_the_auto-release_period_expires._This_helps_protect_buyers_from_fraud.' => 'Configure escrow protection to hold vendor earnings until the buyer confirms receipt or the auto-release period expires. This helps protect buyers from fraud.',
    'dispute_system_is_currently_disabled_by_the_administrator' => 'Dispute system is currently disabled by the administrator',
    'dispute_window_has_expired' => 'Dispute window has expired',
    'disputes_must_be_opened_within' => 'Disputes must be opened within',
    'days_of_delivery' => 'Days of delivery',
    'Did_not_receive_product' => 'Did not receive product',
    ...
    'Escalated' => 'Escalated',
    'Request_Closure_(Buyer_Must_Confirm)' => 'Request Closure (Buyer Must Confirm)',
    'Attach_up_to_5_files_(JPG/PNG_max_5MB,_MP4_max_50MB)' => 'Attach up to 5 files (JPG/PNG max 5MB, MP4 max 50MB)',
    'dispute_id' => 'Dispute id',
    'yes_close_dispute' => 'Yes close dispute',
    'disputes_are_opened_from_delivered_orders' => 'Disputes are opened from delivered orders',
    'by_confirming_you_agree_this_dispute_is_resolved_and_no_further_action_is_needed' => 'By confirming you agree this dispute is resolved and no further action is needed',
    'confirm_dispute_closure' => 'Confirm dispute closure',
    ...
    'Closure_is_awaiting_buyer_confirmation.' => 'Closure is awaiting buyer confirmation.',
    'pending_closure' => 'Pending closure',
    'confirm_i_am_satisfied_close_dispute' => 'Confirm i am satisfied close dispute',
    'please_confirm_closure_if_your_issue_is_resolved' => 'Please confirm closure if your issue is resolved',
    'admin_has_requested_to_close_this_dispute' => 'Admin has requested to close this dispute',
    'closure_pending_your_confirmation' => 'Closure pending your confirmation',
    'auto_closed' => 'Auto closed',
    'closed' => 'Closed',
    'resolved_released' => 'Resolved released',
    'Buyer_confirmed_closure' => 'Buyer confirmed closure',
    'under_admin_review' => 'Under admin review',
    'My_Disputes' => 'My Disputes',
    'submitted_evidence' => 'Submitted evidence',
    'This_dispute_is_resolved_—_messaging_is_disabled.' => 'This dispute is resolved — messaging is disabled.',
    'vendor_responded' => 'Vendor responded',
    'dispute' => 'Dispute',
    'please_fill_in_your_address_information_first' => 'Please fill in your address information first',
    'Open_Dispute' => 'Open Dispute',
    'Only_jpg,_jpeg,_png,_and_mp4_files_are_allowed' => 'Only jpg, jpeg, png, and mp4 files are allowed',
    'Release_Due' => 'Release Due',
    'Action_Needed' => 'Action Needed',
    'Escalate_to_Admin' => 'Escalate to Admin',
    'If_you_cannot_resolve_this_with_the_buyer,_you_can_escalate_to_admin.' => 'If you cannot resolve this with the buyer, you can escalate to admin.',
    'Caption_(optional)' => 'Caption (optional)',
    'No_further_action_is_required_from_you.' => 'No further action is required from you.',
    'This_dispute_has_been_escalated_and_is_currently_under_admin_review._Please_await_the_admin_decision.' => 'This dispute has been escalated and is currently under admin review. Please await the admin decision.',
    'File_(Image_JPG/PNG_max_5MB,_Video_MP4_max_50MB)' => 'File (Image JPG/PNG max 5MB, Video MP4 max 50MB)',
    'Upload_Evidence' => 'Upload Evidence',
    'Type_a_message_to_the_buyer...' => 'Type a message to the buyer...',
    'vendor_response' => 'Vendor response',
    'Files_(Image_JPG/PNG_max_5MB,_Video_MP4_max_50MB)' => 'Files (Image JPG/PNG max 5MB, Video MP4 max 50MB)',
    'evidence_uploaded_successfully' => 'Evidence uploaded successfully',
    ...
    'Select_Main_Category' => 'Select Main Category',
    'Codes_have_been_emailed_to_you_too._Keep_them_safe.' => 'Codes have been emailed to you too. Keep them safe.',
    'Keep_your_Order_ID_handy_for_tracking.' => 'Keep your Order ID handy for tracking.',
    'Retrieving_your_digital_codes' => 'Retrieving your digital codes',
    'View_Your_Codes_&_Receipt' => 'View Your Codes & Receipt',
    'View_Receipt' => 'View Receipt',
    'Warning:_Do_not_share_your_codes_with_anyone.' => 'Warning: Do not share your codes with anyone.',
    'Your_codes_are_taking_longer_than_expected._They_will_be_sent_to_your_email_shortly.' => 'Your codes are taking longer than expected. They will be sent to your email shortly.',
    'Your_order_is_confirmed._You_will_receive_an_email_with_tracking_details.' => 'Your order is confirmed. You will receive an email with tracking details.',
    'Email_is_ready_to_register' => 'Email is ready to register',
    'Email_sent_successfully.' => 'Email sent successfully.',
    'your_verification_code_is' => 'Your verification code is',
    'Choose_the_type_of_products_this_category_will_contain.' => 'Choose the type of products this category will contain.',
    'Category_Type' => 'Category Type',
    'Select_Category_Type' => 'Select Category Type',
    'category_image_must_be_' => 'Category image must be ',
    'Turn_on_if_this_category_contains_digital_products,_or_leave_off_for_physical_products.' => 'Turn on if this category contains digital products, or leave off for physical products.',
    ...
    'Only' => 'Only',
    'Products_in_Sub_Category' => 'Products in Sub Category',
    'Products_in_Sub_Sub_Category' => 'Products in Sub Sub Category',
    'your_area' => 'Your area',
    'Verified_Merchants_Operating_in' => 'Verified Merchants Operating in',
    'Best_Selling_Products_in' => 'Best Selling Products in',
    'search_by_shop_name' => 'Search by shop name',
    'Category_Display_Blocks' => 'Category Display Blocks',
    'location_filters_best_selling_products_verified_merchants' => 'Location filters best selling products verified merchants',
    'block_order_updated_successfully' => 'Block order updated successfully',
    'Full_Location_Filtering_Pipeline' => 'Full Location Filtering Pipeline',
    'vendors_list_with_location_filters_and_search' => 'Vendors list with location filters and search',
    'Vendors_List' => 'Vendors List',
    'Please_select_country_city_or_area_to_view_results' => 'Please select country city or area to view results',
    'No_sub_categories_found' => 'No sub categories found',
    'e.g._Downtown' => 'E.g. Downtown',
    'A_digital_product_code_is_required_before_creating_a_ready_product!' => 'A digital product code is required before creating a ready product!',
    'A_digital_product_code_is_required_before_creating_a_ready_product' => 'A digital product code is required before creating a ready product',
    '.jpeg,.png,.jpg,.webp_Image_size_:Max_20MB_' => '.jpeg,.png,.jpg,.webp Image size :Max 20MB ',
    'Required_for_Ready_Product._You_can_add_more_codes_after_saving_using_the_bulk_import_tool.' => 'Required for Ready Product. You can add more codes after saving using the bulk import tool.',
    'e.g._XXXX-XXXX-XXXX-XXXX' => 'E.g. XXXX-XXXX-XXXX-XXXX',
    'required' => 'Required',
    'Card_Code' => 'Card Code',
    'Add_at_least_one_digital_code_before_saving._Use_the_bulk_import_tool_to_add_multiple_codes.' => 'Add at least one digital code before saving. Use the bulk import tool to add multiple codes.',
    'expiry_date' => 'Expiry date',
    'Adding...' => 'Adding...',
    'Code_added_successfully' => 'Code added successfully',
    'Add_a_single_code_directly._Duplicate_PINs_and_serial_numbers_are_rejected_automatically.' => 'Add a single code directly. Duplicate PINs and serial numbers are rejected automatically.',
    'serial_number' => 'Serial number',
    'card_code' => 'Card code',
    'Add_Single_Code_Manually' => 'Add Single Code Manually',
    'exchange_rate_is_required' => 'Exchange rate is required',
    'Language_&_Currency' => 'Language & Currency',
    'mixed_products_with_location_filters_and_search' => 'Mixed products with location filters and search',
    'Mixed_Products_from_All_Vendors' => 'Mixed Products from All Vendors',
    'displays_products_in_sub_sub_categories' => 'Displays products in sub sub categories',
    'displays_sub_sub_categories_hierarchy' => 'Displays sub sub categories hierarchy',
    'displays_products_filtered_by_sub_categories' => 'Displays products filtered by sub categories',
    'Transaction_report' => 'Transaction report',
    ...
    'Step' => 'Step',
    'add_block' => 'Add block',
    'no_content_configured_for_this_category' => 'No content configured for this category',
    'e.g._Discover_Local' => 'E.g. Discover Local',
    'optional_section_title' => 'Optional section title',
    'want_to_delete_this_block' => 'Want to delete this block',
    'drag_to_reorder' => 'Drag to reorder',
    'vendors_list_requires_at_least_one_other_active_display_block' => 'Vendors List requires at least one other active display block. Enable another block so customers can continue after selecting a vendor.',
    'vendors_list_requires_an_active_block_after_it_in_the_layout' => 'Place at least one active display block after Vendors List in the layout so vendor selection can open the next step.',
    'failed_to_save_block_order' => 'Failed to save block order',
    'vendors_list_must_be_the_first_block_in_the_layout' => 'Vendors List must be the first block in the layout.',
    'vendors_list_requires_sub_categories_block_after_it' => 'Enable Sub Category after Vendors List so customers can continue after selecting a vendor.',
    'vendors_list_requires_products_in_sub_category_or_sub_sub_category_path' => 'Enable Products in Sub Category, or Sub Sub Category plus Products in Sub Sub Category, after Sub Category.',
    'sub_categories_must_come_after_vendors_list' => 'Sub Category must be placed after Vendors List.',
    'products_in_sub_category_must_come_after_sub_categories' => 'Products in Sub Category must be placed after Sub Category.',
    'sub_sub_categories_must_come_after_sub_categories' => 'Sub Sub Category must be placed after Sub Category.',
    'products_in_sub_sub_category_must_come_after_sub_sub_categories' => 'Products in Sub Sub Category must be placed after Sub Sub Category.',
    'vendors_list_layout_requirement_hint' => 'For Vendors List to work, keep it as the first block, then Sub Category, then either Products in Sub Category or Sub Sub Category followed by Products in Sub Sub Category.',
    'drag_vendors_list_to_top_before_enabling_it' => 'Drag Vendors List to the top first. You can enable the other blocks in any order, then turn on Vendors List last.',
    'enable_companion_blocks_before_vendors_list_toggle' => 'Before enabling Vendors List: turn on Sub Category plus either Products in Sub Category, or both Sub Sub Category and Products in Sub Sub Category.',
    'vendors_list_setup_guide_title' => 'Vendors List setup',
    'vendors_list_setup_guide_block_order' => 'Block order: Vendors List → Sub Category → Products in Sub Category, or Sub Sub Category → Products in Sub Sub Category.',
    'vendors_list_setup_guide_drag_first' => 'Drag Vendors List to the top of the layout before enabling it.',
    'vendors_list_setup_guide_enable_order' => 'Enable the other blocks in any order, then turn on Vendors List last.',
    'vendors_list_setup_guide_before_vendors' => 'Before enabling Vendors List, turn on Sub Category plus either Products in Sub Category, or both Sub Sub Category and Products in Sub Sub Category.',
    'block_layout' => 'Block layout',
    'drag_blocks_to_reorder_how_the_customer_app_and_web_render_this_main_category' => 'Drag blocks to reorder how the customer app and web render this main category',
    'back_to_categories' => 'Back to categories',
    'balance_transferred_successfully' => 'Balance transferred successfully',
    'transfer_failed' => 'Transfer failed',
    'transfer_to_vendor_wallet' => 'Transfer to Vendor Wallet',
    'send_balance_to_vendor' => 'Send Balance to Vendor',
    'wallet_transfer_to_customer' => 'Wallet Transfer to Customer',
    'wallet_transfer' => 'Wallet Transfer',
    'your_wallet_balance' => 'Your Wallet Balance',
    'search_customer' => 'Search Customer',
    'send_balance_to_customer' => 'Send Balance to Customer',
    'please_select_a_customer' => 'Please select a customer',
    'transfer_history' => 'Transfer History',
    'add_a_note' => 'Add a note',
    'wallet_transfer_to_customers' => 'Wallet Transfer to Customers',
    'transfer_balance' => 'Transfer Balance',
    'configure_the_order_and_visibility_of_sections_shown_on_app_and_web_for' => 'Configure the order and visibility of sections shown on app and web for',
    'click_manage_to_customize_module_access_for_each_vendor' => 'Click manage to customize module access for each vendor',
