<div class="bg-white product-details-sticky product-details-sticky-section pt-4 pt-md-3 pb-3 {{ $productDetails->variation && count(json_decode($productDetails->variation)) > 0 ? 'multi-variation-product' : '' }}">
    ...
    <div class="container product-cart-option-container mobile__views">
        <form class="add-to-cart-sticky-form addToCartDynamicForm" action="{{ route('cart.add') }}"
            ...
            <div class="product-details-sticky-top">
                <div class="border-bottom d-flex flex-column gap-3 mb-3 pb-3">
                    ...
                    <div class="position-relative">
                        ...
                        <div>
                            <ul class="option-select-btn custom_01_option flex-wrap weight-style--two gap-3 pt-2 p-1 flex-nowrap text-nowrap overflow-x-auto overflow-y-hidden scrollbar-none">
                                @foreach (json_decode($productDetails->colors) as $key => $color)
                                    <li>
                                        <label>
                                            ...
                                            >
                                            <span
                                                class="color_variants rounded focus-preview-image-by-color p-0 border-0 {{ $key == 0 ? 'color_variant_active':''}}"
            ...
            <div class="d-flex align-items-center gap-2 gap-sm-3 gap-xl-4">
                <div class="quantity quantity--style-two d-flex align-items-center justify-content-between w-130px min-width-120 h-40px rounded overflow-hidden">
                    ...
                    <input type="text"
                           data-details-page="1"
                           class="quantity__qty product_quantity__qty w-100 fs-12"
                           name="quantity"
                    ...
                    <span class="quantity__plus btn-number single-quantity-plus form-control h-100 bg--light w-32px" data-type="plus" data-field="quantity" data-form=".add-to-cart-sticky-form">
