<div
    class="variation_wrapper mt-3 physical_product_show show-for-physical-product {{ $product->product_type == 'digital' ? 'd--none' : '' }}">
                ...
                <div class="bg-section rounded-10 p-12 p-sm-20">
                    <div class="row gy-4 align-items-end">
                        ...
                        <div class="col-md-12 mt-2 mb-2">
                            <div class="row customer-choice-options-container my-0 gy-4"
...
<div
    class="variation_wrapper mt-3 show-for-digital-product {{ $product->product_type == 'physical' ? 'd--none' : '' }}">
    <div class="outline-wrapper">
        <div class="card rest-part bg-animate">
            <div
                class="card-header d-flex justify-content-end align-items-center gap-3 border-0 pc-header-ai-btn shadow-none">
                    ...
                    <div class="row gy-4" id="digital-product-type-choice-section">
                        <div class="col-12">
                            <div class="multi--select">
                                ...
                                <select class="custom-select form-control" name="file-type" multiple
