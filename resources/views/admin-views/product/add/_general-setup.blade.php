            ...
            <div class="card-body">
                <div class="bg-section rounded-10 p-12 p-sm-20">
                    <div class="row gy-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                    <select name="product_type" id="product_type" class="form-select"
                                        data-required-msg="{{ translate('product_type_field_is_required') }}" required>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="custom-select action-get-request-onchange" name="category_id"
                                    ...
                                    data-required-msg="{{ translate('category_name_is_required') }}" required>
                        ...
                        <div class="col-md-12 show-for-digital-product" id="digital-product-code-wrapper">
                            <div class="form-group">
                                <label class="form-label" for="digital_product_code">
                                    ...
                                    <span class="tooltip-icon cursor-pointer" data-bs-toggle="tooltip"
                                        aria-label="{{ translate('Optionally add one code now. Use the bulk import tool to add multiple codes at once.') }}"
                                        data-bs-title="{{ translate('Optionally add one code now. Use the bulk import tool to add multiple codes at once.') }}">
                                        <i class="fi fi-sr-info"></i>
                                    </span>
                                </label>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" minlength="6" id="generate-sku-code" name="code"
                                    ...
                                    placeholder="{{ translate('ex') . ': 161183' }}"
                                    data-required-msg="{{ translate('sku_field_is_required') }}" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 show-for-physical-product">
                            <div class="form-group">
                        ...
                        <input type="hidden" id="generated_combinations" name="generated_combinations"
                            value="">
                    </div>
                </div>
            </div>
